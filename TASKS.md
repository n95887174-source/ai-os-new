...
_(Полный список #1–100 см. в `docs/tasks/01-provider-tasks.md`, оригинал в `temp/`)_
...
_(Полный список #101–200 см. в `docs/tasks/02-chat-tasks.md`, оригинал в `temp/`)_
...
_(Полный список #201–305 см. в `docs/tasks/03-debate-tasks.md`, оригинал в `temp/`)_
...
> Реальность (2026-07-05): read-side ✅, write-side (persistence, replay, archive) ✅ — все фичи реализованы в `debate-session-persistence.ts` + `debate-replay-engine.ts`
...
> Реальность (2026-07-05): EventBus ✅, Timeline ✅, Snapshot read ✅. Control Plane ✅ (debate-policy-engine + room), DebateRoom ✅, Workspace ✅, Cross-Debate Memory ✅ (extractor + rag), Verdict Layer ✅ (conclusion-engine + verdict panel)
...
| 7 — Strategy & Mode     | P0/P1/P2  |   5   | ~12 дней | ✅ 5/5 — DSL + Mode System + Mode Manager + Visual Builder + Strategy Manager done |
...
_Merged from: ai-os_audit_report.md, ai-os_audit_report_2026.md, docs/AUDIT_TASKS.md, docs/AUDIT_TASKS2.md, docs/HONEST_REPORT.md, docs/provaiderstasks.md, docs/chatstasks.md, docs/tasks/_.md*
