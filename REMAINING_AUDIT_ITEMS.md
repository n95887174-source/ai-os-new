...
> Updated 2026-07-10 — All mock services replaced with real implementations
>
...
## Remaining Medium (42 → 29 resolved, 13 remaining / 1 actionable)
...
| 112 | `2e`  | `P1`     | Remove or label mock services (C1-C8)                    | 🟢 **Fixed 2026-07-10** — PersonaMarketplaceService: BucketStorageAdapter CRUD, no mock. NvidiaEnterpriseService: NGC API + providerTracker + pricingService |
...
| --------- | ------ | ----------------- | ------------------ | ------------- |
| 🟡 Medium | 42     | 29                | 10 (risks)         | 1 (#172 a11y) |
| 🔵 Low    | 19     | 19                | 0                  | 0             |
| **Total** | **61** | **48**            | **10**             | **1**         |
