...
| #   | Что сделано                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Диагностика: все 32 route id (route-imports.ts:420-451) уже мапятся на `ComingSoonPanel` (сделано в `96907a4d`, P0.10) — но файлы-заглушки с фейковым UI оставались в `src/components/`                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 2   | `rg "Афина\|Гермес\|SAMPLE_ARGUMENTS"` — 15 файлов с demo-контентом; весь каталог `src/components/` сверен с route id → 32 панели-заглушки (Steelman, BayesianJudge, BlindEval, Credibility, Calibration, Consistency, FrameTracker, StanceDrift, InsightBus, Entanglement, Anchoring, MetaAgent, OutcomeForecaster, ConceptBlender, BeliefMining, MinimaxPlanner, ExpertWitness, Rhetoric, BiasProfiler, IncentiveDetector, Stakeholder, Scratchpad, PersonaMixer, BoPTracker, GotDeliberation, SimilarityMonitor, DriftDetector, ShadowOpponent, AdversarialSource, VulnTargeting, Justification, LogicalForm) |
| 3   | Каждая панель — однофайловая demo-заглушка (только self-import, 0 внешних импортов, 0 i18n, 0 сервисных импортов, hardcoded "Афина vs Гермес") — подтверждено `rg` (0 совпадений за пределами самих файлов)                                                                                                                                                                                                                                                                                                                                                                                                      |
| 4   | Удалены все 32 директории (`git rm`), роуты продолжают показывать ComingSoonPanel — приложение не ломается                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 5   | tsc 0 errors, build 15.02s ✅                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
