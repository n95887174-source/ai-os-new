                                ...
                                >
                                    ...
                                    {step.decision && (
                                        <Brain
                                            size={14}
                                            color={
                                                selectedStepId === step.id ? '#60a5fa' : '#3b82f6'
                                            }
                                            aria-hidden="true"
                                        />
                                    )}
                    ...
                    {selectedStep ? (
                        ...
                        >
                            ...
                            {selectedStep.decision && (
                                <div style={{ marginBottom: '2.5rem' }}>
                                    <h3 style={h3SectionLgFlex}>
                                        <Target size={18} color="#3b82f6" aria-hidden="true" />{' '}
                                        Decision Logic
                                    </h3>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                {selectedStep.decision.alternatives.map(
                                                    (alt, _altIdx) => (
                                                        <div
                                                            key={alt.id}
                                                            style={{
                                        ...
                                        >
                                            ...
                                            >
                                                <div style={metricBlurCard}>
                                                    ...
                                                    >
                                                        {Math.round(
                                                            selectedStep.decision.confidence * 100,
                                                        )}
                                                        %
                                                    </div>
                                                </div>
                                                <div style={metricBlurCard}>
                                                    ...
                                                    >
                                                        {Math.round(
                                                            (1 - selectedStep.decision.confidence) *
                                                                100,
                                                        )}
                                                        %
                                                    </div>
                            ...
                            {selectedStep.thoughts && selectedStep.thoughts.length > 0 && (
                                <div style={{ marginBottom: '2.5rem' }}>
                                    <h3 style={h3SectionLgFlex}>
                                        <Brain size={18} color="#a855f7" aria-hidden="true" />{' '}
                                        Thought Process
                                    </h3>
                                    <div
                                        style={{
