    ...
    <div style={flexColGap6}>
                ...
                >
                    ...
                    >
                        <div
                            style={{
                                padding: '0.6rem',
                                background: `rgba(${card.border === '#3b82f6' ? '59,130,246' : card.border === '#a855f7' ? '168,85,247' : card.border === '#10b981' ? '16,185,129' : '245,158,11'},0.1)`,
                                borderRadius: 10,
                            }}
                        >
                            {card.icon}
        ...
        <div
            ...
            style={{
                ...
                background: 'linear-gradient(145deg, rgba(59,130,246,0.05) 0%, transparent 100%)',
                marginTop: '1rem',
            }}
        >
            <h4
            ...
            >
                <div>
                    <strong style={{ color: '#60a5fa' }}>KeyService</strong> — Key CRUD, encryption,
                    health, quotas, pools
                    <br />
                    <strong style={{ color: '#60a5fa' }}>RouterService</strong> — UCB1 bandit, SLA
                    modes, fallback chains
                    <br />
                    <strong style={{ color: '#60a5fa' }}>RotationService</strong> — Auto key
                    rotation, TTL, scheduling
                    <br />
                    <strong style={{ color: '#60a5fa' }}>MemoryService</strong> — BM25 + semantic
                    search, Orama worker
                    <br />
                    <strong style={{ color: '#60a5fa' }}>ToolService</strong> — Script/API/DB tools,
                    sandboxed execution
                </div>
                <div>
                    <strong style={{ color: '#60a5fa' }}>OrchestrationService</strong> —
                    Topology-driven multi-node DAG execution
                    <br />
                    <strong style={{ color: '#60a5fa' }}>AdvisorService</strong> — Meta-agent for
                    system optimization
                    <br />
                    <strong style={{ color: '#60a5fa' }}>PolicyService</strong> — Guardrails
                    (latency, PII, cost)
                    <br />
                    <strong style={{ color: '#60a5fa' }}>HealthCheckService</strong> — Provider key
                    liveness verification
                    <br />
                    <strong style={{ color: '#60a5fa' }}>MCPService</strong> — Model Context
...
const ApiReference = () => (
    <div style={flexColGap6}>
        ...
        {[
            ...
            <div key={api.title} className="glass-panel" style={glassPanelPad15r}>
                <div
                    style={{
                        display: 'flex',
                        alignItems: 'center',
        ...
        >
            ...
            <div style={{ fontSize: '0.85rem', color: '#cbd5e1', lineHeight: 2 }}>
                <code style={{ color: '#3b82f6' }}>'chat:send'</code> — Incoming chat request
                <br />
                <code style={{ color: '#3b82f6' }}>'chat:stream:chunk'</code> — Streaming response
                chunk
                <br />
                <code style={{ color: '#3b82f6' }}>'chat:stream:end'</code> — Stream completion
                <br />
                <code style={{ color: '#3b82f6' }}>'router:signal'</code> — Routing decision
                feedback
                <br />
                <code style={{ color: '#3b82f6' }}>'kernel:updated'</code> — State change
                notification
                <br />
                <code style={{ color: '#3b82f6' }}>'system:notification'</code> — UI notification
                <br />
                <code style={{ color: '#3b82f6' }}>'cognitive:step:completed'</code> — Pipeline step
                done
                <br />
                <code style={{ color: '#3b82f6' }}>'policy:violation'</code> — Policy guardrail
                triggered
            </div>
        </div>
    </div>
...
const Changelog = () => (
    <div style={flexColGap6}>
        ...
        {[
            ...
            <div key={release.version} className="glass-panel" style={glassPanelPad15r}>
                <div
                    style={{
                        display: 'flex',
                        alignItems: 'center',
