...
export const AgentSchedulerPanel: React.FC = () => {
    ...
    if (!schedulerService) return null;
    ...
    const confirmDelete = async () => {
        if (!deleteConfirm || !schedulerService) return;
                            ...
                            <div style={{ display: 'flex', gap: '0.5rem' }}>
                                <button
                                    onClick={async () => {
                                        ...
                                        try {
                                            await schedulerService.trigger(s.id);
                                        } catch {
                                            /* ignore */
                                        }
                                        setSchedules(schedulerService.getAll());
                                    ...
                                    style={{
                                        ...
                                        color: '#3b82f6',
                                        cursor: 'pointer',
                                        opacity: triggeringId === s.id ? 0.5 : 1,
                                    }}
