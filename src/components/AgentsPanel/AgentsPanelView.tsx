...
const AgentsPanelView: React.FC = () => {
    ...
    useEffect(() => {
        templateService
            ...
            .catch((err) => console.warn('[AgentsPanel] Failed to load templates', err));
            ...
            <div className="agents-header">
                ...
                <div className="agents-actions">
                    <button
                        ...
                        aria-label={t('agents.export_aria')}
                    >
                    ...
                    <button
                        ...
                        className="agents-action-btn btn-secondary"
                        aria-label={t('agents.import_aria')}
                    >
                    ...
                    <button
                        ...
                        aria-label={t('agents.spawn_agent_aria')}
                    >
                                ...
                                <motion.div
                                    ...
                                    onKeyDown={(e) => {
                                        if (e.key === 'Enter' || e.key === ' ') {
                                            e.preventDefault();
                                            onSetSelectedAgentId(agent.id);
                                        }
                                    }}
                                >
                                    <div
                                        className={`agents-card-indicator agents-card-indicator--${agent.status}`}
                                    />
                                    ...
                                    <div className="agents-card-tags">
                                        {agent.tools.slice(0, 3).map((tool) => (
                                            <span key={tool} className="agents-card-tag">
                                                <Wrench
                                                    size={10}
                                                    className="agents-card-tag-icon"
                                                />{' '}
                                                {tool}
                                            </span>
                                        ))}
                                        {agent.tools.length > 3 && (
                                            <span className="agents-card-tag-more">
                                                +{agent.tools.length - 3}
                                            </span>
                                        )}
                                        {agent.tools.length === 0 && (
                                            <span className="agents-card-tag-empty">
                                                {t('agents.no_capabilities')}
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    <div className="agents-card-footer">
                                        <div className="agents-card-stats">
                                            ...
                                            <div className="agents-card-stat">
                                                ...
                                                <span
                                                    className={`agents-card-stat-value${(() => {
                                                        const s = agentStats[agent.id];
                                                        if (!s || s.calls === 0) return '';
                                                        const rate =
                                                            (s.calls - (s.errors ?? 0)) / s.calls;
                                                        return rate > 0.95
                                                            ? ' agents-card-stat-value--good'
                                                            : rate > 0.8
                                                              ? ' agents-card-stat-value--warn'
                                                              : ' agents-card-stat-value--bad';
                                                    })()}`}
                                                >
                                                    {(() => {
                                                        const s = agentStats[agent.id];
                                                        if (!s || s.calls === 0) return '--';
                                                        return `${Math.round(((s.calls - (s.errors ?? 0)) / s.calls) * 100)}%`;
                                                    })()}
                                                </span>
                                            </div>
                                            <div className="agents-card-stat">
                                                ...
                                                <span
                                                    className={`agents-card-stat-value${(agentStats[agent.id]?.errors || 0) > 0 ? ' agents-card-stat-value--bad' : ''}`}
                                                >
                                            ...
                                            <div className="agents-card-stat">
                                                ...
                                                <span
                                                    className={`agents-card-stat-value${(agentStats[agent.id]?.latency || 0) < 500 ? ' agents-card-stat-value--good' : (agentStats[agent.id]?.latency || 0) < 1000 ? ' agents-card-stat-value--warn' : ' agents-card-stat-value--bad'}`}
                                                >
                                                    {agentStats[agent.id]?.latency || 0}
                                                    <span
                                                        style={{
                                                            fontSize: '0.65rem',
                                                            color: '#64748b',
                                        ...
                                        <div className="agents-card-engine">
                                            <span className="agents-card-engine-label">
                                                Provider / Model
                                            </span>
                                            <span className="agents-card-engine-value">
                                                {agent.providerId === 'Auto'
                                                    ? 'Smart Router'
                                                    : agent.providerId}
                                                {agent.model !== 'auto'
                        ...
                        <div className="agents-modal glass-panel">
                            <div className="agents-modal-header">
                                <div className="agents-modal-header-left">
                                    ...
                                    <div className="agents-modal-header-info">
                                        ...
                                        <div className="agents-modal-header-meta">
                                            <span className="agents-modal-header-role">
                                                {agent.role}
                                            </span>
                                ...
                                <div className="agents-modal-header-actions">
                                    ...
                                    <button
                                        onClick={() => onSetSelectedAgentId(null)}
                            ...
                            <div className="agents-modal-body">
                                ...
                                >
                                    {sidebarTabs.map((tab) => (
                                        ...
                                        >
                                            <span className="agents-modal-sidebar-btn-icon">
                                                {tab.icon}
                                            </span>{' '}
                                ...
                                <div className="agents-modal-content">
                                    <AnimatePresence mode="wait">
                                        ...
                                        >
                                                ...
                                                <>
                                                    <div className="agents-config-grid">
                                                        <div className="agents-config-field">
                                                            <label
                                                                className="agents-config-label"
                                                                htmlFor="agents-node-name"
                                                            >
                                                                Node Name
                                                            </label>
                                                            <input
                                                        ...
                                                        <div className="agents-config-field">
                                                            <label
                                                                className="agents-config-label"
                                                                htmlFor="agents-behavior-blueprint"
                                                            >
                                            ...
                                            {activeTab === 'capabilities' && (
                                                <div className="agents-tools-grid">
                                                    {availableTools.map((tool) => {
                                                        const isEquipped = agent.tools.includes(
                                                            tool.id,
                                                        );
                                                        return (
                                                            <div
                                                ...
                                                <div className="agents-infra-panel">
                                                    <div className="agents-infra-row">
                                                        <div className="agents-infra-header">
                                                            <label
                                                                className="agents-infra-label"
                                                                htmlFor="agents-temp-slider"
                                                            >
                                                                Entropy (Temperature)
                                                            </label>
                                                            <span className="agents-infra-value-badge">
                                                                {agent.temperature}
                                                            </span>
                                                        </div>
                                                        <input
                                            ...
                                            {activeTab === 'observability' && (
                                                <div style={flexColGap5}>
                                                    <div className="agents-obs-header">
                                                        <Activity size={14} /> Node interceptor
                                                        attached. Stream active.
                                                    </div>
                                                    {(() => {
                                                        const s = agentStats[agent.id];
                                                        if (!s || s.calls === 0) {
                                                            return (
                                                                <div className="agents-obs-entry-wait">
                                                                    Waiting for inference payload...
                                                                </div>
                                                            );
                                                        }
                                                        const successRate =
                                                        ...
                                                        const totalPct = latencyBuckets.reduce(
                                                            (sum, b) => sum + b.pct,
                                                            0,
                                                        );
                                                            ...
                                                            <>
                                                                ...
                                                                <div style={infoCardDark}>
                                                                    ...
                                                                    >
                                                                        {(() => {
                                                                            const pct =
                                                                                metricsService.getAgentPercentiles(
                                                                                    agent.id,
                                                                                );
                                                                            const entries = [
                                                                                {
                                                                ...
                                                                <div className="agents-obs-entry">
                                                                    ...
                                                                    <span className="agents-obs-entry-ok">
                                                                        200 OK
                                                                    </span>
                                            ...
                                            {activeTab === 'handoffs' && (
                                                <div
                                                    className="agents-handoffs-panel"
                                                    style={{
                                                        padding: '1rem',
                                                        display: 'flex',
                                                ...
                                                >
                                                    {(() => {
                                                        const handoffs =
                                                            taskHandoffService.getHandoffs(
                                                                agent.id,
                                                            );
                                                        ...
                                                        return handoffs.map((h) => (
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    <span
                                                                        className={`agents-handoff-status agents-handoff-status--${h.status}`}
                                                                        style={{
                                                                            fontSize: '0.7rem',
                                                                            textTransform:
                                                                                'uppercase',
