...
const RoutingIntelligence: React.FC = () => {
    ...
    const getExplanation = (d: RouterDecision): string[] => {
        ...
        if (topBreakdown.ttft > 0.5)
            lines.push('TTFT weight high — favoring low-latency providers');
            ...
            {view === 'ab-test' ? (
                ...
                <div>
                    <div style={textMutedSm}>
                        Visual decision flow — how each request is routed through the scoring
                        pipeline
                    </div>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        />
                                                        <div>
                                                            <div style={textWhiteWeight700Sm}>
                                                                {node.label}
                                                            </div>
                                                            {node.sub && (
                                                                <div
                            ...
                            {decisions.map((d, i) => {
                                ...
                                return (
                                    <div
                                        ...
                                        onClick={() =>
                                            setSelected(
                                                selected?.requestId === d.requestId ? null : d,
                                            )
                                        }
                                        style={{
                                            padding: '1rem',
                                ...
                                >
                                    <div style={detailRow}>
                                        ...
                                        <div>
                                            ...
                                            >
                                                {STRATEGY_LABELS[selected.strategy] ||
                                                    selected.strategy}
                                            </div>
                                        </div>
                                    </div>
                ...
                <div style={flexColGap5}>
                    ...
                    <div className="glass-panel" style={glassPanel}>
                        <h3 style={sectionHeader}>
                            <Settings2 size={18} color="#f59e0b" /> Service Level Agreement (SLA)
                            Mode
                        </h3>
                        <div
                            style={{
                            ...
                            {[
                                {
                                    id: 'BALANCED',
                                    label: 'Balanced',
                                    desc: 'Optimal mix of speed and cost',
                                },
                                {
                                    id: 'PERFORMANCE',
                                    label: 'Performance',
                                    desc: 'Prioritize low latency and quality',
                                },
                                {
                                    id: 'COST',
                                    label: 'Economy',
                                    desc: 'Strictly minimize token costs',
                                },
                            ].map((mode) => (
                                <div
                                    key={mode.id}
                                    ...
                                    <div style={flexColGap3}>
                                        ...
                                        >
                                            ...
                                            {names.map((name) => (
                                                <button
                                                    key={name}
                                                    onClick={async () => {
                                                        await actions.setActiveProfile(name);
                                                    }}
                                                    style={{
                                                        ...
                                                        fontWeight: 700,
                                                        cursor: 'pointer',
                                                        border: `1px solid ${name === active ? 'rgba(139,92,246,0.4)' : 'rgba(255,255,255,0.08)'}`,
                                                        background:
                                                            name === active
                                                                ? 'rgba(139,92,246,0.15)'
                                                                : 'rgba(0,0,0,0.2)',
                                                        color:
                                                            name === active ? '#a855f7' : '#94a3b8',
                                                    }}
                                                >
                                                    {name}
                                                    {name === 'default' ? ' (system)' : ''}
                                        ...
                                        {names.filter((n) => n !== 'default').length === 0 && (
                                            <div style={textXsItalicMuted}>
                                                Create a new profile to experiment with weight
                                                tuning. Clone the default profile and adjust
                                                parameters.
                                            </div>
                                        )}
                                    </div>
                    ...
                    >
                        <div className="glass-panel" style={glassPanel}>
                            ...
                            <div style={flexColGap4}>
                                {config &&
                                    Object.entries(config.fallbackChains).map(
                                        ([strategy, chain]) => (
                                            <div
                                                key={strategy}
                                                style={{
                                            ...
                                            >
                                                ...
                                                <div style={flexColGap2}>
                                                    ...
                                                    <button
                                                        onClick={() => addFallbackLink(strategy)}
                                                        style={{
                                                            marginTop: '0.25rem',
                                                            padding: '0.5rem',
                                                            borderRadius: 8,
                        ...
                        <div className="glass-panel" style={glassPanel}>
                            ...
                            >
                                ...
                                <button
                                    onClick={addDowngradeChain}
                                    title="Add downgrade chain"
                                    style={iconBtnBlue}
                                >
                                    <Plus size={14} />
                                </button>
                            ...
                            >
                                {config &&
                                    Object.entries(config.modelDowngradeChains).map(
                                        ([model, chain]) => (
                                            <div
                                                key={model}
                                                style={{
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        onClick={() => addDowngradeItem(model)}
                                                        style={{
                                                            padding: '0.45rem',
                                                            borderRadius: 8,
