...
export default function NvidiaKeyTable() {
    ...
    const load = useCallback(async () => {
        ...
        setKeys(
            all.filter(
                (k) =>
                    k.provider.toLowerCase() === 'nvidia-nim' ||
                    k.provider.toLowerCase() === 'nvidia',
            ),
        );
    }, []);
    ...
    const handleTest = (apiKey: ApiKey) => {
        ...
        const reqId = `nvidia-test-${apiKey.id}-${crypto.randomUUID().slice(0, 6)}`;
    ...
    return (
        <div>
            ...
            >
                <span style={{ color: NVIDIA }}>◆</span> NVIDIA NIM Keys
            </h3>
            {keys.length === 0 ? (
                <div
                    style={{
                ...
                >
                    No NVIDIA NIM keys configured. Add one in Providers.
                </div>
            ) : (
                                        ...
                                        <button
                                            ...
                                            style={{
                                                ...
                                                background: test?.loading
                                                    ...
                                                    : `${NVIDIA}22`,
                                                color: test?.loading ? '#6b7280' : NVIDIA,
                                            }}
                                        >
                                            {test?.loading ? (
