...
import { flexCenterGap2, flexColGap3, sectionTitleLarge, textMutedSm, webhookInput } from '../../styles/common';
import { SettingRow, Toggle } from './settings-shared';

interface AlertsTabProps {
  webhooks: WebhookConfig[];
  setWebhooks: (webhooks: WebhookConfig[]) => void;
  webhookForm: { name: string; url: string; provider: WebhookProvider; events: WebhookEventType[] };
  setWebhookForm: React.Dispatch<
    React.SetStateAction<{ name: string; url: string; provider: WebhookProvider; events: WebhookEventType[] }>
  >;
          ...
          <button
            ...
            onClick={() => {
              ...
              setWebhookForm({
                ...
                events: [(eventOptions[0] || 'system:notification') as WebhookEventType],
              });
              setWebhooks(refreshWebhooks());
            }}
          >
