  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', height: '100%', overflowY: 'auto' }}>
      ...
      <div style={{ display: 'flex', gap: '2rem', height: '100%', minHeight: 0, flexWrap: 'wrap' }}>
        <div
          style={{ width: 260, maxWidth: '100%', display: 'flex', flexDirection: 'column', gap: '0.5rem', flexShrink: 0 }}
          role="tablist"
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', fontSize: '0.75rem', color: '#94a3b8' }}>
              <div style={flexJustifyBetween}>
                ...
                <span style={{ color: '#e2e8f0', fontWeight: 600, fontFamily: 'monospace' }}>v{APP_VERSION}</span>
              </div>
              <div style={flexJustifyBetween}>
                <span>{t('settings.build_id')}</span>{' '}
                <span style={{ color: '#e2e8f0', fontWeight: 600, fontFamily: 'monospace' }}>{CONFIG.buildId}</span>
              </div>
              <div style={flexJustifyBetween}>
                <span>{t('settings.kernel_label')}</span>{' '}
                <span style={{ color: canonicalHealthColor('ready'), fontWeight: 700 }}>{canonicalHealthLabel('ready')}</span>
              </div>
            </div>
          </div>
        </div>
