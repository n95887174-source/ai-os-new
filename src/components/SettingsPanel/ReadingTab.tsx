...
import { detailsContainer, detailsSummary, sectionTitleLarge, textSecondary } from '../../styles/common';
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginBottom: '1rem' }}>{t('settings.restart_desc')}</div>
        <button
          type="button"
          onClick={() => {
