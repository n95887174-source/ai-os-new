  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <div style={{ fontSize: '1.1rem', fontWeight: 700, color: '#f8fafc' }}>Debate System Prompts</div>
          <div style={{ fontSize: '0.8rem', color: '#64748b', marginTop: '0.25rem' }}>
            Customize the system prompts for each agent role in debates
          </div>
        </div>
        <button onClick={handleReset} style={{ padding: '0.5rem 1rem', borderRadius: 8, background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)', color: '#ef4444', cursor: 'pointer', fontWeight: 700, fontSize: '0.8rem', display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <div key={role} style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
            ...
            <textarea
              ...
              style={{
                ...
                color: '#e2e8f0', fontSize: '0.85rem', fontFamily: '"JetBrains Mono", monospace',
