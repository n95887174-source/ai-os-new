                                        ...
                                        {loadingTools[server.id] ? (
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    {serverResources[server.id]?.length > 0 ? (
                                                        serverResources[server.id].map((res) => (
                                                            <div
                                                                key={res.uri}
                                                                style={{
                                                                    padding: '0.75rem',
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={editing.name || ''}
                                        onChange={(e) =>
                                            setEditingServer({ ...editing, name: e.target.value })
                                        }
                                        style={{
                                            width: '100%',
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={editing.url || ''}
                                        onChange={(e) =>
                                            setEditingServer({ ...editing, url: e.target.value })
                                        }
                                        style={{
                                            width: '100%',
                                            padding: '0.85rem 1rem',
                            ...
                            >
                                ...
                                <button
                                    onClick={() => {
                                        ...
                                        try {
                                            if (editing.id) {
                                                mcpService.updateServer(editing.id, {
                                                    name: editing.name,
                                                    url: editing.url,
                                                });
                                            } else {
                                            ...
                                            setError(
                                                `Failed to save server: ${err instanceof Error ? err.message : String(err)}`,
                                            );
                                            clearError();
                                        }
                                    }}
