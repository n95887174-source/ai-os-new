...
const mockSkills = [
  { id: 'sk-1', name: 'Deep Web Researcher', description: 'Multi-step research', category: 'analysis', status: 'active', toolsUsed: ['Search', 'Summarizer'], version: '2.1.0', executionCount: 47 },
  { id: 'sk-2', name: 'Code Reviewer Pro', description: 'Review code', category: 'analysis', status: 'installed', toolsUsed: ['Git CLI', 'Linter'], version: '1.4.2', executionCount: 23 },
  { id: 'sk-3', name: 'Social Media Manager', description: 'Manage socials', category: 'generation', status: 'not_installed', toolsUsed: ['Twitter API'], version: '3.0.1', executionCount: 0 },
];
...
describe('SkillsPanel', () => {
  ...
  it('search filters skills in marketplace', async () => {
    ...
    const search = document.querySelector('input[placeholder="Search extension hub..."]') as HTMLInputElement;
