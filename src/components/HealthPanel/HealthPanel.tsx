                ...
                {[
                    ...
                    <div
                        ...
                        style={{
                            padding: '1.5rem',
                            borderRadius: 16,
                            borderTop: `4px solid ${vital.color}`,
                            background: `linear-gradient(180deg, ${vital.color}0A 0%, rgba(0,0,0,0) 100%)`,
                    ...
                    >
                        ...
                        >
                            <motion.div
                                animate={{ width: `${vital.fill}%` }}
                                transition={{ type: 'spring' }}
                                style={{ height: '100%', background: vital.color, borderRadius: 2 }}
                            />
                        </div>
                    </div>
                ))}
                    ...
                    >
                        ...
                        <span style={{ marginLeft: 'auto', fontSize: '0.72rem', color: '#64748b' }}>
                            {t('health.probe_ready', {
                                ready: Array.from(probeResults.values()).filter(
                                    (r) => r.status === 'ready',
                                ).length,
                ...
                return (
                    ...
                    >
                        ...
                        >
                            ...
                            <h3 style={h3White}>
                                {t('health.health_score_title') || 'Health Score Overview'}
                            </h3>
                            <span
                            ...
                            {allKeyStates.map((ks) => {
                                ...
                                const recoveryMinutes =
                                    ks.healthScore < HEALTH_THRESHOLDS.healthy
                                        ? Math.ceil(
                                              (HEALTH_THRESHOLDS.healthy - ks.healthScore) / 5,
                                          )
                                        : 0;
            ...
            >
                ...
                {healthEvents.length === 0 ? (
                    ...
                    >
                        {healthEvents
                            .filter(
                                (e) => healthEventFilter === 'all' || e.type === healthEventFilter,
                            )
                            .slice(0, 50)
                            .map((ev, i) => {
                                const eventColor =
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            {ev.type === 'latency_spike'
                                                ? t('health.event_latency_spike')
                                                : ev.type === 'error_burst'
                                                  ? t('health.event_error_burst')
                                                  : ev.type === 'status_change'
                                                    ? t('health.event_status_change')
                                                    : ev.type === 'rate_limit'
                                                      ? t('health.event_rate_limit')
