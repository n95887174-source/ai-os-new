...
const PatternsPanel: React.FC = () => {
    const [activeTab, setActiveTab] = useState<'all' | 'google' | 'groq' | 'nvidia' | 'openrouter'>(
        'all',
    );
                    ...
                    <button
                        ...
                        onClick={() =>
                            eventBus.emit(EVENTS.NOTIFICATION, {
                                message: t('patterns.coming_soon'),
                                type: 'info',
                            })
                        }
                    >
            ...
            >
                {['all', 'google', 'groq', 'nvidia', 'openrouter'].map((tab) => (
                    <button
                        key={tab}
                        onClick={() =>
                            setActiveTab(tab as 'all' | 'google' | 'groq' | 'nvidia' | 'openrouter')
                        }
                        style={{
                            ...
                            >
                                <span
                                    style={{
                                        fontSize: '0.8rem',
                                        textTransform: 'uppercase',
                                        color: providerColors[selectedNote.provider || 'all'],
                                        fontWeight: 800,
                                        letterSpacing: '0.1em',
                                    }}
                                >
                                    {selectedNote.provider || t('patterns.detail.generic')} /{' '}
