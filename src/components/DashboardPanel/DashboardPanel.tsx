      ...
      <AnimatePresence>
        {providerCounts.active === 0 && keys.length === 0 && (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: '1.05rem', fontWeight: 700, color: '#f8fafc', marginBottom: '0.25rem' }}>
          ...
          >
            ...
            <div style={flex1}>
              ...
              <div style={{ fontSize: '0.8rem', color: '#fecaca', opacity: 0.8 }}>
                {t('dashboard.alert_provider_errors', { errors: providerCounts.error, violations: systemState.violations?.length ?? 0, fallback: fallbackEnabled ? t('common.active') : t('common.disabled') })}
              </div>
            </div>
