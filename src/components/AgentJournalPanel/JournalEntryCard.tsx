        ...
        >
            <div style={{ minWidth: 0 }}>
                ...
                >
                    ...
                    <span style={{ ...textWhiteXs, fontSize: '0.85rem' }}>{entry.agentName}</span>
                    <span style={{ ...textMutedXs, fontSize: '0.7rem' }}>· {entry.taskType}</span>
                    <span style={textMutedXs}>· {new Date(entry.timestamp).toLocaleString()}</span>
                </div>
