    ...
    >
        <div style={nodeDetailRow}>
            <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <Cpu size={12} /> {tt('builder.model_engine')}
            </span>
            <span
                style={{
                    fontWeight: 600,
        ...
        >
            ...
            <div
                style={{
                    flex: 1,
                    display: 'grid',
                    gridTemplateColumns: isNarrow ? '1fr' : '280px 1fr 340px',
                    gap: '1rem',
                    minHeight: 0,
                }}
            >
                        ...
                        {[
                            {
                                type: 'agent',
                                icon: Bot,
                                label: t('builder.node.agent'),
                                desc: t('builder.node.agent_desc'),
                                color: '#3b82f6',
                            ...
                            },
                            {
                                type: 'router',
                                icon: GitBranch,
                                label: t('builder.node.router'),
                                desc: t('builder.node.router_desc'),
                                color: '#f59e0b',
                            ...
                            },
                            {
                                type: 'guardrail',
                                icon: ShieldCheck,
                                label: t('builder.node.guardrail'),
                                desc: t('builder.node.guardrail_desc'),
                                color: '#10b981',
                            ...
                            },
                            {
                                type: 'tool',
                                icon: Blocks,
                                label: t('builder.node.tool'),
                                desc: t('builder.node.tool_desc'),
                                color: '#8b5cf6',
                                        ...
                                        <>
                                            ...
                                            <div>
                                                ...
                                                <textarea
                                                    ...
                                                    placeholder={t(
                                                        'builder.system_prompt_placeholder',
                                                    )}
                                                    value={
                                                        (activeNode.data.config as ISNode['config'])
                                                            ?.prompt || ''
