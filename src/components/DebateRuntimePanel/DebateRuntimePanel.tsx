...
const DebateRuntimePanel: React.FC = () => {
    ...
    useEffect(() => {
        return () => {
            isMountedRef.current = false; /* Note: destroy() intentionally omitted — useDebateLiveStore is a singleton shared between DebatePanel and DebateRuntimePanel */
        };
    }, []);
        ...
        <div style={debateRuntimeRoot}>
            ...
            >
                                            ...
                                            >
                                                <div
                                                    style={{
                                                        ...
                                                        height: 16,
                                                        borderRadius: 3,
                                                        border: `1px solid ${selected ? '#a78bfa' : '#475569'}`,
                                                        background: selected
                                                            ? '#a78bfa'
                                                            : 'transparent',
                                                        display: 'flex',
                ...
                <div style={flexColGap3}>
                    <h3 style={debateRuntimeSectionTitle}>
                        <Activity size={16} />{' '}
                        {t('debate_runtime.active_sessions', { count: sessions.length })}
                    </h3>
                    {sessions.length === 0 ? (
                        ...
                        sessions.map((s) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span>
                                        {t('debate_runtime.topology', { value: s.topology.type })}
                                    </span>
                                    <span>
                                        {t('debate_runtime.agents_count', {
                                            count: s.agentStates.length,
                                        })}
                                    </span>
                                </div>
            ...
            {selected && (
                <div style={purpleBorderSection}>
                    ...
                    >
                        ...
                        >
                            ...
                            {linkedChatIds.map((linkedId) => (
                                <button
                                    ...
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        navigate(`/chat?session=${linkedId}`);
                                    }}
                                    style={{
                                        fontSize: '0.65rem',
                                        padding: '2px 8px',
                        ...
                        <div style={flexGap2}>
                            {(selected.phase === 'active' || selected.phase === 'deliberating') && (
                                <button
                                    onClick={() => {
                                        debateService.pauseDebateSession(selected.id);
                                        refreshSessions();
                                    }}
                                    style={{
                                        ...buttonSmAction,
                            ...
                            {selected.phase === 'created' && (
                                <button
                                    onClick={() => {
                                        debateService.startDebateSession(selected.id);
                                        refreshSessions();
                                    }}
                            ...
                            {['active', 'deliberating', 'paused'].includes(selected.phase) && (
                                <button
                                    onClick={() => {
                                        debateService.cancelDebateSession(selected.id);
                                        refreshSessions();
                                    }}
                                    style={{
                                        ...buttonSmAction,
                        ...
                        >
                            ...
                            {(sessionArgs.get(selected.id) || []).length > 0 && (
                                <span style={{ fontSize: '0.7rem', color: '#94a3b8' }}>
                                    ({(sessionArgs.get(selected.id) || []).length})
                                </span>
                            )}
                        </button>
                        <button
                                    ...
                                    >
                                        <div style={flexJustifyBetween}>
                                            <span style={textSecondary}>
                                                {t('debate_runtime.debate_quality')}
                                            </span>
                                            <span
                                                style={{
                                                    color:
                                        ...
                                        <div style={flexJustifyBetween}>
                                            ...
                                            <span
                                                style={{
                                                    color:
                                                        cognitiveMetrics.avgContradictionDensity >
                                                        0.5
                                                            ? '#ef4444'
                                                            : '#94a3b8',
                                                    fontWeight: 600,
                                            ...
                                            >
                                                {(
                                                    cognitiveMetrics.avgContradictionDensity * 100
                                                ).toFixed(0)}
                                                %
                                            </span>
                                        </div>
                                        <div style={flexJustifyBetween}>
                                            ...
                                            <span
                                                style={{
                                                    color:
                                                        cognitiveMetrics.avgConsensusConfidence >
                                                        0.6
                                                            ? '#22c55e'
                                                            : '#94a3b8',
                                                    fontWeight: 600,
                                            ...
                                            >
                                                {(
                                                    cognitiveMetrics.avgConsensusConfidence * 100
                                                ).toFixed(0)}
                                                %
                                            </span>
                                        </div>
                                        <div style={flexJustifyBetween}>
                                            ...
                                            >
                                                {(
                                                    cognitiveMetrics.avgReasoningCoherence * 100
                                                ).toFixed(0)}
                                                %
                                            </span>
                                        </div>
                                        ...
                                        >
                                            <span>
                                                {t('debate_runtime.score', {
                                                    value: (cognitivePressure.score * 100).toFixed(
                                                        0,
                                                    ),
                                                })}
                                            </span>
                                            ...
                                            <span>
                                                {t('debate_runtime.contention', {
                                                    value: (
                                                        cognitivePressure.contentionScore * 100
                                                    ).toFixed(0),
                                                })}
                                            </span>
                                            <span>
                                                {t('debate_runtime.complexity', {
                                                    value: (
                                                        cognitivePressure.complexityScore * 100
                                                    ).toFixed(0),
                                                })}
                                            </span>
                                        </div>
                            ...
                            {(sessionArgs.get(selected.id) || []).length === 0 ? (
                                ...
                                (() => {
                                    ...
                                    const streamingIds = new Set(
                                        args
                                            .filter((a) => a.id.startsWith('streaming-'))
                                            .map((a) => a.id),
                                    );
                                    return (
                                        <DebateChat
                    ...
                    {sessionViewTab === 'controls' && <AgentControlPanel session={selected} />}
                </div>
            )}
            ...
            {diagnosticIssues.length > 0 && (
                <div style={debateRuntimeIssuePanel}>
                    ...
                    >
                        <AlertCircle size={14} />{' '}
                        {t('debate_runtime.active_issues', { count: diagnosticIssues.length })}
                    </h4>
                    {diagnosticIssues.map((issue, _i) => (
                        <div
                            key={issue.message}
                            style={{
                                padding: '0.4rem 0.6rem',
            ...
            <div style={grid2}>
                <div style={cognitiveCard}>
                    <h4 style={h3Section}>
                        <Brain size={14} style={iconMarginRight} />{' '}
                        {t('debate_runtime.cognitive_metrics')}
                    </h4>
                    {cognitiveMetrics ? (
                        <div style={flexColGap3FontSize075}>
                            ...
                            <div style={flexJustifyBetween}>
                                <span style={textSecondary}>
                                    {t('debate_runtime.avg_contradiction')}
                                </span>
                                <span
                                    style={{
                                        color:
                                            cognitiveMetrics.avgContradictionDensity > 0.4
                                                ? '#ef4444'
                                                : '#94a3b8',
                                        fontWeight: 600,
                                    }}
                            ...
                            <div style={flexJustifyBetween}>
                                <span style={textSecondary}>
                                    {t('debate_runtime.avg_coherence')}
                                </span>
                                <span
                                    style={{
                                        color:
                            ...
                            <div style={flexJustifyBetween}>
                                <span style={textSecondary}>
                                    {t('debate_runtime.avg_confidence')}
                                </span>
                                <span
                                    style={{
                                        color:
                ...
                <div style={cognitiveCard}>
                    ...
                    {cognitivePressure ? (
                        <div style={flexColGap3FontSize075}>
                            <div style={flexJustifyBetween}>
                                ...
                                <span
                                    style={{
                                        ...
                                        color:
                                            PRESSURE_COLORS[
                                                cognitivePressure.level as PressureLevel
                                            ] || '#94a3b8',
                                        textTransform: 'uppercase',
                                    }}
                                >
                            ...
                            <div style={flexJustifyBetween}>
                                <span style={textSecondary}>
                                    {t('debate_runtime.active_chains')}
                                </span>
                                <span style={{ color: '#e2e8f0', fontWeight: 600 }}>
                                    {cognitivePressure.activeReasoningChains}
                                </span>
                            </div>
                            <div style={flexJustifyBetween}>
                                <span style={textSecondary}>
                                    {t('debate_runtime.contention_label')}
                                </span>
                                <span
                                    style={{
                                        color:
                                            cognitivePressure.contentionScore > 0.5
                                                ? '#f59e0b'
                                                : '#94a3b8',
                                        fontWeight: 600,
                                    }}
                            ...
                            <div style={flexJustifyBetween}>
                                <span style={textSecondary}>
                                    {t('debate_runtime.complexity_label')}
                                </span>
                                <span
                                    style={{
                                        color:
                                            cognitivePressure.complexityScore > 0.6
                                                ? '#f59e0b'
                                                : '#94a3b8',
                                        fontWeight: 600,
                                    }}
