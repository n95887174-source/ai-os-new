        ...
        >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    ...
                    >
                        <BarChart3 size={28} color="#3b82f6" aria-hidden="true" />{' '}
                        {t('analytics.title')}
                    </h2>
                ...
                >
                    {[
                        ...
                        <button
                            key={tab.id}
                            onClick={() =>
                                setActiveTab(tab.id as 'overview' | 'providers' | 'decisions')
                            }
                            role="tab"
                            ...
                            >
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        value: (kernelState.totalTokens || 0).toLocaleString(),
                                    ...
                                    },
                                    {
                                        ...
                                        value: `$${(kernelState.estimatedCost || 0).toFixed(4)}`,
                            ...
                            >
                                        ...
                                        <div>
                                            <h3 style={{ ...h3ChartTitle, margin: '0 0 0.25rem' }}>
                                                <TrendingUp
                                                    ...
                                                    aria-hidden="true"
                                                />{' '}
                                                {t('analytics.chart.token_throughput')}
                                            </h3>
                                            <div style={{ fontSize: '0.75rem', color: '#94a3b8' }}>
                                                Real-time telemetry aggregated over the last 24
                                                hours.
                                            </div>
                                        </div>
                                        <div
                                ...
                                >
                                    <h3 style={h3ChartTitle}>
                                        <GitMerge size={18} color="#3b82f6" aria-hidden="true" />{' '}
                                        {t('analytics.traffic_distribution')}
                                    </h3>
                                ...
                                >
                                    ...
                                    >
                                        {(() => {
                                            ...
                                            const avgEwmaLatency =
                                                all.reduce((a, m) => a + m.avgTTFT, 0) / all.length;
                                            const avgReliability =
                                                all.reduce((a, m) => a + m.reliability, 0) /
                                                all.length;
                                            const totalReqs = all.reduce(
                                                (a, m) => a + m.totalRequests,
                                                0,
                                            );
                                            const errorRate =
                                                totalReqs > 0 ? (1 - avgReliability) * 100 : 0;
                                            return (
                                                <>
                                                    <div
                                                        style={{
                                    ...
                                    {healthEvents.length > 0 && (
                                        ...
                                        >
                                            ...
                                            >
                                                Recent health events (ProviderTracker)
                                            </div>
                                            <div
                                                style={{
                                                    display: 'flex',
                        ...
                        >
                            {Object.values(metrics).map((m) => {
                                const maxTTFT = Math.max(
                                    ...Object.values(metrics).map((p) => p.avgTTFT),
                                    1,
                                );
                                const maxTPS = Math.max(
                                    ...Object.values(metrics).map((p) => p.avgTPS),
                                    1,
                                );
                                return (
                                    <motion.div
                                            ...
                                            >
                                                ...
                                                <div
                                                    style={{
                                                        ...
                                                        fontWeight: 800,
                                                        color:
                                                            m.stabilityIndex > 0.8
                                                                ? '#10b981'
                                                                : '#f59e0b',
                                                    }}
                                                >
                                                    {(m.stabilityIndex * 100).toFixed(0)}%
                                                </div>
                                                <div
                                                    style={{
                                                        marginTop: '0.2rem',
                                        ...
                                        >
                                            ...
                                            <span
                                                style={{
                                                    ...
                                                    fontWeight: 800,
                                                    color:
                                                        m.reputationScore > 70
                                                            ? '#10b981'
                                                            : m.reputationScore > 40
                                                              ? '#f59e0b'
                                                              : '#ef4444',
                                                }}
                                            >
                                                {m.reputationScore.toFixed(0)}/100
                                            </span>
                                        </div>
                                    </motion.div>
                                );
                                ...
                                >
                                    <div>
                                        ...
                                        {d.skipped && d.skipped.length > 0 && (
                                            ...
                                            >
                                                Skipped:{' '}
                                                {d.skipped.map((s) => s.provider).join(', ')}
                                            </div>
                                        )}
                                    </div>
                                    <div
