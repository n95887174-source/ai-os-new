...
import { Loader2, AlertCircle, CheckCircle2, Activity, ChevronRight, Package, GitFork, Zap, RefreshCw, ThumbsUp, ThumbsDown } from 'lucide-react';
import { motion } from 'framer-motion';
import type { ChatResponse } from '../../types/chat';
import ProviderIcon from '../ProviderIcon/ProviderIcon';
import { MarkdownRenderer } from './MarkdownRenderer';
import { ContextMenu } from '../Common/ContextMenu';
import { errorCard, flexCenterGap3, flexCenterGap6px, flexCenterSmGap, flexCol, iconBtnMuted } from '../../styles/common';
...
const ResponseCard: React.FC<ResponseCardProps> = memo(({ res, entryId, displayMode = 'standard', onFork, onRegenerate }) => {
