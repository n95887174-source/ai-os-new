...
const ChatHistoryEntry: React.FC<ChatHistoryEntryProps> = memo(({ entry, entryIdx, isEditing, editText, isSplitView, displayMode, onStartEdit, onCancelEdit, onSaveEdit, onSetEditText, onFork, onRegenerate }) => {
