                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        ...
                        <div>
                            <span style={{ fontWeight: 700, fontSize: '0.95rem' }}>
                                {activeSession?.title || t('chat.no_session')}
                            </span>
                            {activeModel && (
                                <span
                                    style={{
                    ...
                    <div style={{ display: 'flex', gap: '0.35rem', alignItems: 'center' }}>
                        ...
                        <button
                            ...
                            style={{
                                ...iconBtnMuted,
                                color:
                                    displayMode === 'technical' ? '#a855f7' : 'var(--text-muted)',
                                background:
                            ...
                            title={
                                displayMode === 'technical'
                                    ? t('chat.standard_mode')
                                    : t('chat.technical_mode')
                            }
                            aria-label={
                                displayMode === 'technical'
                                    ? t('chat.standard_mode')
                ...
                {showSearchWithinChat && (
                    ...
                    >
                        ...
                        {searchWithinResults.length > 0 && (
                            ...
                            >
                                <button
                                    onClick={() => setSearchWithinIndex((i) => Math.max(0, i - 1))}
                                    style={iconBtnMuted}
                                    aria-label={t('chat.previous_match')}
                                >
                                    <ChevronRight
                                        size={14}
                                ...
                                <span>
                                    {searchWithinIndex + 1}/{searchWithinResults.length}
                                </span>
                                <button
                                    onClick={() =>
                ...
                <div style={{ flex: 1, overflow: 'auto', padding: '1.5rem 2rem' }}>
                    {historyEntries && historyEntries.length > 0 ? (
                        ...
                        >
                            ...
                            <div
                                style={{ fontSize: '0.85rem', maxWidth: 400, textAlign: 'center' }}
                            >
                                {t('chat.empty_desc')}
                            </div>
                        </div>
