            ...
            >
                <div>
                    ...
                    <p style={{ color: '#94a3b8', margin: 0, fontSize: '1rem' }}>
                        Manage all active threads, review past cognitive workflows, and clear agent
                        memory.
                    </p>
                </div>
            </div>
            ...
            >
                {[
                    ...
                    },
                    {
                        ...
                        icon: <MessageCircle size={28} color="#a855f7" />,
                    ...
                    <div style={flexWrapGap4}>
                        ...
                        {selectedSessionIds.length > 0 && (
                            <button
                                ...
                                aria-label={`Delete ${selectedSessionIds.length} selected chat sessions`}
                            >
                                        ...
                                        <td style={tdPadding}>
                                            <div style={flexWrapGap4}>
                                                <div style={statBadgePill}>
                                                    ...
                                                    {session.history.length} Prompts
                                                </div>
                                                <div style={statBadgePill}>
                                                    <Share2 size={16} color="#a855f7" />
                                                    {session.history.reduce(
                                                        (acc, h) => acc + h.responses.length,
                                                        0,
                                                    )}{' '}
                                                    Responses
                                                </div>
