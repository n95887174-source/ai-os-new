    ...
    <div style={{ textAlign: 'center', padding: '0.5rem 0' }}>
        ...
        >
            {[
                ...
                {
                    icon: <Bot size={16} />,
                    label: t('onboarding.feature_debates'),
                    color: '#a855f7',
                },
                {
                    icon: <Zap size={16} />,
                    label: t('onboarding.feature_agents'),
                    color: '#f59e0b',
                },
                {
                    icon: <Shield size={16} />,
                    label: t('onboarding.feature_private'),
                    color: '#3b82f6',
                },
            ].map((f) => (
                <div
...
const AddConnectionStep: React.FC<AddConnectionStepProps> = ({
    t,
    selectedProvider,
    setSelectedProvider,
    apiKey,
