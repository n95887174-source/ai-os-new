...
const ConnectorsPanel: React.FC = () => {
                ...
                if (count > 0) {
                    ...
                    if (stored) {
                        try {
                            ...
                            console.warn(
                                '[ConnectorsPanel] Failed to migrate connectors from localStorage:',
                                e,
                            );
    ...
    const handleAddCustom = useCallback(() => {
        ...
        eventBus.emit(EVENTS.NOTIFICATION, {
            message: `Connector ${newConnector.name} added.`,
            type: 'success',
        });
    ...
    const handleTabKeyDown = useCallback(
        (e: React.KeyboardEvent, view: 'grid' | 'webhooks') => {
        ...
        <div className="connector-wrapper">
            <div className="connector-header">
                <div className="connector-header-left">
                    <h2 className="connector-heading">
                        <Server size={28} color="#3b82f6" aria-hidden="true" />{' '}
                        {t('connectors.title')}
                    </h2>
                    ...
                    {activeView === 'grid' ? (
                                        ...
                                        >
                                            ...
                                            <div className="connector-card-footer">
                                                <div style={flexAlignCenterGap2}>
                                                    ...
                                                    />
                                                    <span
                                                        className="connector-status-label"
                                                        style={{ color: sc.color }}
                                                    >
                                                        {t(
                                                            STAT_LABELS[c.status] ||
                                                                'connectors.status.offline',
                                                        )}
                                                    </span>
                                                </div>
                            ...
                            {showAddForm ? (
                                <div className="connector-form-card">
                                    <div className="connector-form-header">
                                        <span className="connector-form-title">
                                            {t('connectors.form_title')}
                                        </span>
                                        <button
                        ...
                        >
                            <div className="connector-webhooks-header">
                                <div>
                                    <h3 className="connector-webhooks-title">
                                        {t('connectors.webhooks_heading')}
                                    </h3>
                                    <p className="connector-webhooks-subtitle">
                                        Allow external systems to push asynchronous events directly
                                        into the OS EventBus.
                                    </p>
                                </div>
                                <button
                                    className="btn-primary"
            ...
            <div className="connector-security-banner">
                ...
                <span className="connector-security-text">
                    <strong style={{ color: '#10b981' }}>Zero-Trust Architecture:</strong> All OAuth
                    tokens and API keys are stored exclusively in the local browser vault. No
                    credentials are ever transmitted to our telemetry servers.
                </span>
            </div>
            ...
            >
                <div ref={modalRef}>
                    ...
                    <p className="connector-modal-body">
                        This will revoke the OAuth token and disconnect the service. You can
