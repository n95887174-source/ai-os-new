...
const MODULES: ModuleCard[] = [
  { id: 'project-os', route: '/project-os', icon: <Search size={20} />, labelKey: 'nav.project_os_explorer', color: '#8b5cf6', descriptionKey: 'project_os_explorer.subtitle' },
  { id: 'hypothesis-gen', route: '/hypothesis-gen', icon: <Lightbulb size={20} />, labelKey: 'nav.hypothesis_generator', color: '#f59e0b', descriptionKey: 'hypothesis_generator.subtitle' },
  { id: 'arch-review', route: '/arch-review', icon: <Zap size={20} />, labelKey: 'nav.architecture_review', color: '#a855f7', descriptionKey: 'arch_review.subtitle' },
  { id: 'prompt-audit', route: '/prompt-audit', icon: <BookOpen size={20} />, labelKey: 'nav.prompt_strategy_audit', color: '#3b82f6', descriptionKey: 'prompt_audit.subtitle' },
  { id: 'routing-experiments', route: '/routing-experiments', icon: <Route size={20} />, labelKey: 'nav.model_routing_experiments', color: '#f59e0b', descriptionKey: 'routing_experiments.subtitle' },
  { id: 'gov-stress-test', route: '/gov-stress-test', icon: <Shield size={20} />, labelKey: 'nav.governance_stress_test', color: '#10b981', descriptionKey: 'gov_stress_test.subtitle' },
  { id: 'obs-gaps', route: '/obs-gaps', icon: <Eye size={20} />, labelKey: 'nav.observability_gaps_scanner', color: '#06b6d4', descriptionKey: 'obs_gaps.subtitle' },
];
  ...
  return (
    <div style={{ height: '100%', overflowY: 'auto', padding: '2rem' }}>
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        <h1 style={{ fontSize: '1.75rem', fontWeight: 800, margin: '0 0 0.5rem', color: '#f8fafc', display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
          {MODULES.map(mod => (
            <div
              ...
              tabIndex={0}
              style={{
                padding: '1.25rem', borderRadius: 16, border: '1px solid rgba(255,255,255,0.05)',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <span style={{ fontSize: '0.9rem', fontWeight: 700, color: '#f8fafc', flex: 1 }}>{t(mod.labelKey)}</span>
        ...
        <div style={{ marginTop: '2rem', padding: '1rem', borderRadius: 12, background: 'rgba(59,130,246,0.05)', border: '1px solid rgba(59,130,246,0.15)' }}>
          <div style={{ fontSize: '0.75rem', fontWeight: 700, color: '#60a5fa', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Reference Docs</div>
          <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
            {['docs/events.md', 'docs/DEBT_REPORT.md', 'docs/ПОЛНЫЙ_РЕЕСТР.md', 'docs/01-system-architecture_RU.md'].map(doc => (
              <a key={doc} href={`/${doc}`} target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.75rem', color: '#60a5fa', padding: '0.2rem 0.5rem', borderRadius: 4, background: 'rgba(59,130,246,0.1)', textDecoration: 'none', fontFamily: 'monospace' }}>
                {doc}
              </a>
            ))}
          </div>
