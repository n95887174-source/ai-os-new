...
const STATUS_CONFIG: Record<
    HypothesisStatus,
    { color: string; labelKey: string; nextStates: HypothesisStatus[] }
> = {
    proposed: {
        color: '#64748b',
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    ...
                                    onKeyDown={(e) => {
                                        if (e.key === 'Enter') toggleExpand(h.id);
                                    }}
                                    role="button"
                                    tabIndex={0}
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <Edit3 size={10} />{' '}
                                                        {editingEvidence === h.id ? 'Done' : 'Edit'}
                                                    </button>
                                                </div>
                                                <div
                                                    style={{
                                        ...
                                        >
                                            ...
                                            {h.status === 'active' && (
                                                ...
                                                >
                                                    <MessageCircle size={11} />{' '}
                                                    {t('hypothesis_generator.start_debate')}
                                                </button>
                                            )}
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                            ...
                            <div>
                                ...
                                {sourceFile && (
                                    ...
                                    >
                                        <ExternalLink size={10} /> Pre-filled from Project OS
                                        Explorer
                                    </div>
                                )}
                            </div>
