        ...
        >
            ...
            {!attached ? (
                ...
                >
                    ...
                    >
                        Attach a project to analyze its architecture — file sizes, directory
                        nesting, and structure stats.
                    </span>
                    <button
                ...
                <>
                            ...
                            {(['error', 'warning', 'info'] as const).map((t) => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        borderRadius: 8,
                                        background: `${typeColor(t)}08`,
                                        border: `1px solid ${typeColor(t)}15`,
                                        display: 'flex',
                                        alignItems: 'center',
                                        gap: 6,
                                    }}
                                >
                                    {t === 'error' ? (
                                        <AlertCircle size={14} color={typeColor(t)} />
                                    ) : t === 'warning' ? (
                                        <AlertTriangle size={14} color={typeColor(t)} />
                                    ) : (
                                        <Info size={14} color={typeColor(t)} />
                                    )}
                                    <div>
                                        <div
                                            style={{
                        ...
                        >
                            ...
                            >
                                <div
                                    ...
                                    onKeyDown={(e) => {
                                        if (e.key === 'Enter') setDebtOpen((v) => !v);
                                    }}
                                    role="button"
                                    tabIndex={0}
                                >
                                    ...
                                    <span style={{ marginLeft: 'auto', display: 'flex', gap: 3 }}>
                                        {debtItems.filter((d) => d.status === 'resolved').length >
                                            0 && <CheckCircle2 size={12} color="#10b981" />}
                    ...
                    >
                        <button
                            onClick={runAnalysis}
                            disabled={scanning || tree.length === 0}
                            style={{
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            ...
                                            onKeyDown={(e) => {
                                                if (e.key === 'Enter') toggleCategory(type);
                                            }}
                                            role="button"
                                            tabIndex={0}
                                        >
