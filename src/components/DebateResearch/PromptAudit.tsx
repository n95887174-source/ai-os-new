                ...
                <div style={{ display: 'flex', gap: 4, height: 24 }}>
                    {tempBuckets.map((b) => {
                        ...
                        return (
                            ...
                            >
                                <span
                                    style={{ fontSize: '0.6rem', color: b.color, fontWeight: 700 }}
                                >
            ...
            >
                ...
                <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
                    {GROUP_ORDER.filter((g) => groupCounts[g]).map((g) => {
                        const pct =
                            agents.length > 0 ? ((groupCounts[g] || 0) / agents.length) * 100 : 0;
            ...
            >
                ...
                <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
                    {mostCommonTools.map(([tool, count]) => (
                        ...
                        >
                            {tool}{' '}
                            <span style={{ color: '#64748b', fontSize: '0.6rem' }}>{count}x</span>
                        </span>
                    ))}
                </div>
            </div>
                ...
                >
                    ...
                    >
                        <div
                            ...
                            onKeyDown={(e) => {
                                if (e.key === 'Enter') setShowSuggestions((v) => !v);
                            }}
                            role="button"
                            tabIndex={0}
                        >
                            ...
                            <span
                                style={{ fontSize: '0.72rem', fontWeight: 700, color: '#f59e0b' }}
                            >
                            ...
                            >
                                <div
                                    style={{
                                        ...
                                        height: 14,
                                        borderRadius: 2,
                                        background: GROUP_COLORS[a.group] || '#64748b',
                                    }}
                                />
                                <span
                                    style={{
