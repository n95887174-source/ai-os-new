                        ...
                        <div className="glass-panel" style={panelRounded16}>
                            ...
                            >
                                ...
                                {selected.classification && (
                                    <ClassificationBadge cls={selected.classification} />
                                )}
                            </div>
                            ...
                            >
                                <div style={inputDarkBg}>
                                    ...
                                    >
                                        {t(STRATEGY_LABELS[selected.strategy] || selected.strategy)}
                                    </div>
                                </div>
                                <div style={inputDarkBg}>
                                    <div style={textMutedWeight700XsMargin}>
                                ...
                                {selected.secondBest && (
                                    <div style={inputDarkBg}>
                                        ...
                                        <div style={flexCenterSmGap}>
                                            <ProviderIcon
                                                provider={selected.secondBest}
                                                size={16}
                                            />
                                            <span
                                                style={{
                                                    fontSize: '0.85rem',
                                                    color: providerColor(selected.secondBest),
                                                    fontWeight: 700,
                                                }}
                                            >
                                                {selected.secondBest}
                        ...
                        <div className="glass-panel" style={panelRounded16}>
                            ...
                            >
                                <span>
                                    ...
                                    {t('router_trace.legend_ttft')}
                                </span>
                                <span>
                                    <span style={{ color: '#34d399' }}>■</span>{' '}
                                    {t('router_trace.legend_tps')}
                                </span>
                                <span>
                        ...
                        {selected.skipped && selected.skipped.length > 0 && (
                            <div className="glass-panel" style={panelRounded16}>
                                <div style={{ ...scoreHeader, marginBottom: '0.75rem' }}>
                                    ...
                                    {t('router_trace.skipped_providers', {
                                        count: selected.skipped.length,
                                    })}
                                </div>
                                <div style={flexColGap1}>
                            ...
                            <div style={flexColGap4}>
                                {selected.scores.map((s, i) => {
                                    ...
                                    return (
                                        <div
                                            key={s.p}
                                            style={isWinner ? winnerRow : scoreRowDefault}
                                        >
                                            <div
                                                style={{
                                                    display: 'flex',
                                            ...
                                            {components && (
                                                ...
                                                >
                                                    <div>
                                                        ...
                                                        <ScoreBar
                                                            label={t(
                                                                'router_trace.score_exploration',
                                                            )}
                                                        ...
                                                        <ScoreBar
                                                            label={t(
                                                                'router_trace.score_key_reputation',
                                                            )}
                                                    ...
                                                    <div>
                                                        <ScoreBar
                                                            label={t(
                                                                'router_trace.score_cost_penalty',
                                                            )}
                                                        ...
                                                        <ScoreBar
                                                            label={t(
                                                                'router_trace.score_latency_penalty',
                                                            )}
                                                        ...
                                                        <ScoreBar
                                                            label={t(
                                                                'router_trace.score_budget_penalty',
                                                            )}
