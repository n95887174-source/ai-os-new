...
const EMOJI_MAP: Record<string, string> = {
  ...
  shield: '\u{1F6E1}', warning: '\u26A0', microscope: '\u{1F52C}', bar_chart: '\u{1F4CA}',
  chart: '\u{1F4C8}', link: '\u{1F517}', gear: '\u2699', robot_face: '\u{1F916}',
  speech_balloon: '\u{1F4AC}', left_right_arrow: '\u{2194}', globe: '\u{1F310}',
  satelite: '\u{1F4E1}', electric_plug: '\u{1F50C}', wrench: '\u{1F527}',
  closed_lock_with_key: '\u{1F510}', mag: '\u{1F50D}', computer: '\u{1F4BB}',
  satellite: '\u{1F4E1}', triangular_ruler: '\u{1F4D0}', floppy_disk: '\u{1F4BE}',
  honeybee: '\u{1F41D}', fish: '\u{1F41F}', ocean: '\u{1F30A}', thermometer: '\u{1F321}',
  vertical_traffic_light: '\u{1F6A6}', four_leaf_clover: '\u{1F340}',
  heartbeat: '\u{1F493}', stethoscope: '\u{1FA7A}', key: '\u{1F511}',
  mega: '\u{1F4E3}', newspaper: '\u{1F4F0}', neural: '\u{1F9E0}',
  card_index_dividers: '\u{1F5C2}', network: '\u{1F5FA}', bulb: '\u{1F4A1}',
  label: '\u{1F3F7}', book: '\u{1F4D6}', busts_in_silhouette: '\u{1F465}',
  heavy_plus_sign: '\u{2795}', dollar: '\u{1F4B5}', chart_with_upwards_trend: '\u{1F4C8}',
  chart_with_upwards_downs: '\u{1F4C9}', deciduous_tree: '\u{1F333}',
  art: '\u{1F3A8}', eye: '\u{1F441}', rock: '\u{1FAA8}', zap: '\u26A1',
  white_check_mark: '\u2705', leftwards_arrow: '\u{2B05}', robot: '\u{1F916}',
};
