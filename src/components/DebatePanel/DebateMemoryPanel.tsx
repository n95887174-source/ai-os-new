...
import { debateService, sessionManager } from '../../kernel/instances';
...
function getCurrentSessions(): DebateSession[] {
    ...
    const handleInjectMemory = useCallback(async () => {
        ...
        try {
            ...
            const memoryText = related
                ...
                .join('\n\n');
            await debateService.addArgument(
                'Memory System',
                            ...
                            >
                                <span
                                    style={{
                                        ...
                                        background:
                                            CONCLUSION_COLORS[
                                                r.session.convergenceScore > 0.7
                                                    ? 'consensus'
                                                    : r.session.convergenceScore > 0.4
                                                      ? 'dominance'
                                                      : 'stalemate'
                                            ] || '#6b7280',
                                    }}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                {filteredSessions.map((session) => {
                    ...
                    const conclusionType =
                        session.convergenceScore > 0.7
                            ? 'consensus'
                            : session.convergenceScore > 0.4
                              ? 'dominance'
                              : 'inconclusive';
                    return (
                        <div
                            ...
                            {isExpanded && (
                                ...
                                >
                                    ...
                                    <div style={{ display: 'flex', gap: 8, marginTop: 6 }}>
                                        ...
                                        >
                                            Convergence:{' '}
                                            {Math.round(session.convergenceScore * 100)}%
                                        </div>
                                        <div
                                            style={{
                                                fontSize: '0.62rem',
