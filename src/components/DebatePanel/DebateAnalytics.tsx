    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', overflowY: 'auto' }}>
                    ...
                    >
                        {[
                            ...
                            },
                            {
                                ...
                                color:
                                    session.graphMetrics.orphanRate > 0.3 ? '#ef4444' : '#f59e0b',
                            },
                            {
                            ...
                            >
                                ...
                                <div
                                    style={{ fontSize: '1.2rem', fontWeight: 800, color: m.color }}
                                >
                                    {m.value}
                                </div>
                            </div>
            ...
            {session.status === 'completed' && session.interpretation && (
                <div className="glass-panel" style={glassPanelRounded24}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
                        {session.interpretation.insights.map((insight, _i) => (
                            <div
                                key={insight}
                                style={{
                                    display: 'flex',
                    ...
                    <div style={flexColGap3MarginTop3}>
                        <div>
                            ...
                            <div style={grid2TinyGap}>
                                ...
                                <span>
                                    ...
                                    <strong style={{ color: '#e2e8f0' }}>
                                        {(
                                            session.qualityMetrics.depth.lexicalDiversity * 100
                                        ).toFixed(0)}
                                        %
                                    </strong>
                                </span>
                                ...
                                <span>
                                    ...
                                    <strong style={{ color: '#e2e8f0' }}>
                                        {(session.qualityMetrics.depth.topicBreadth * 100).toFixed(
                                            0,
                                        )}
                                        %
                                    </strong>
                        ...
                        <div style={borderTopSection}>
                            <div style={flexBetweenCenterSm}>
                                ...
                                >
                                    {Math.round(
                                        session.qualityMetrics.originality.noveltyScore * 100,
                                    )}
                                    %
                                </span>
                            </div>
                            <div style={grid2TinyGap}>
                                <span>
                                    ...
                                    <strong
                                        style={{
                                            color:
                                                session.qualityMetrics.originality.selfRepetition >
                                                0.3
                                                    ? '#ef4444'
                                                    : '#e2e8f0',
                                        }}
                                    >
                                        {(
                                            session.qualityMetrics.originality.selfRepetition * 100
                                        ).toFixed(0)}
                                        %
                                    </strong>
                                </span>
                                <span>
                                    ...
                                    <strong
                                        style={{
                                            color:
                                                session.qualityMetrics.originality.crossRepetition >
                                                0.3
                                                    ? '#ef4444'
                                                    : '#e2e8f0',
                                        }}
                                    >
                                        {(
                                            session.qualityMetrics.originality.crossRepetition * 100
                                        ).toFixed(0)}
                                        %
                                    </strong>
                                </span>
                        ...
                        <div style={borderTopSection}>
                            <div style={flexBetweenCenterSm}>
                                ...
                                >
                                    {Math.round(
                                        session.qualityMetrics.usefulness.usefulnessScore * 100,
                                    )}
                                    %
                                </span>
                            </div>
                            ...
                            >
                                <div style={metricBoxSmall}>
                                    ...
                                    >
                                        {Math.round(
                                            session.qualityMetrics.usefulness.relevanceScore * 100,
                                        )}
                                        %
                                    </div>
                                ...
                                <div style={metricBoxSmall}>
                                    ...
                                    >
                                        {Math.round(
                                            session.qualityMetrics.usefulness.evidenceScore * 100,
                                        )}
                                        %
                                    </div>
                                ...
                                <div style={metricBoxSmall}>
                                    ...
                                    >
                                        {Math.round(
                                            session.qualityMetrics.usefulness.structureScore * 100,
                                        )}
                                        %
                                    </div>
                    ...
                    >
                        {session.activityMetrics.perAgent.map((a, i) => {
                            const maxCount = Math.max(
                                ...session.activityMetrics!.perAgent.map((x) => x.argumentCount),
                                1,
                            );
                            const maxChildren = Math.max(
                                ...session.activityMetrics!.perAgent.map((x) => x.childrenReceived),
                                1,
                            );
                            const pct = (a.argumentCount / maxCount) * 100;
                            const childrenPct = (a.childrenReceived / maxChildren) * 100;
                            const heatColor =
                                pct > 66 ? '#ef4444' : pct > 33 ? '#f59e0b' : '#3b82f6';
                            return (
                                <div key={a.agentId} style={{ fontSize: '0.72rem' }}>
                                    ...
                                    >
                                        ...
                                        >
                                            {a.argumentCount} {t('debate.args')} &middot;{' '}
                                            {a.wordCount} {t('debate.words')} &middot;{' '}
                                    ...
                                    {i < session.activityMetrics!.perAgent.length - 1 &&
                                        i ===
                                            Math.min(
                                                2,
                                                session.activityMetrics!.perAgent.length - 2,
                                            ) &&
                                        session.activityMetrics!.perAgent.length > 4 && (
                                            <div
                                                style={{
                    ...
                    <div className="glass-panel" style={glassPanelRounded24}>
                        ...
                        >
                            {session.activityMetrics.mostDiscussed.map((arg) => {
                                const maxChildren = Math.max(
                                    ...session.activityMetrics!.mostDiscussed.map(
                                        (x) => x.childCount,
                                    ),
                                    1,
                                );
            ...
            {session.status === 'completed' &&
                args.length > 0 &&
                (() => {
                    const roundNumbers = [...new Set(args.map((a) => a.round))].sort(
                        (a, b) => a - b,
                    );
                    const roundCounts = roundNumbers.map(
                        (r) => args.filter((a) => a.round === r).length,
                    );
                        ...
                        <div className="glass-panel" style={glassPanelRounded24}>
                            ...
                            >
                                {roundNumbers.map((r, ri) => {
                                    ...
                                    const avgConf =
                                        roundArgs.reduce((s, a) => s + (a.confidence || 0), 0) /
                                        roundArgs.length;
                                    const timelinePoint =
                                        session.interpretation?.disagreementTimeline?.find(
                                            (point) => point.round === r,
                                        );
                                    const intensity =
                                        timelinePoint?.intensity ?? roundCounts[ri] / maxRoundCount;
                                    const isPeak =
                                        session.interpretation?.disagreementPeak?.round === r;
                                        ...
                                        >
                                            ...
                                            <div style={{ flex: 1, minWidth: 0 }}>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {agentIds.length} {t('debate.agents')}{' '}
                                                        &middot; {roundArgs.length}{' '}
                                                        {t('debate.arg_short')}
