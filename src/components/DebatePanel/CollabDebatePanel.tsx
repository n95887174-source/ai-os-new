...
import { Users, UserPlus, UserMinus, Send, MessageSquare, Shield, Swords, Scale } from 'lucide-react';
...
const CollabDebatePanel: React.FC<Props> = ({ session, getAgentLabel }) => {
  ...
  return (
    <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', padding: '1rem 2rem', background: 'rgba(0,0,0,0.15)' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '0.75rem' }}>
        <Users size={16} color="#a855f7" />
        <span style={{ fontWeight: 700, color: '#e2e8f0', fontSize: '0.9rem' }}>Collaborative Mode</span>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', alignItems: 'center' }}>
          <input
            ...
            style={{
              ...
              background: 'rgba(0,0,0,0.3)', color: '#e2e8f0', fontSize: '0.85rem', width: 140,
            }}
          ...
          {(['pro', 'con', 'judge', 'neutral'] as CollabRole[]).map(r => (
            <button
              ...
              style={{
                ...
                background: role === r ? `${ROLE_COLORS[r]}20` : 'rgba(255,255,255,0.03)',
        ...
        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center', flexWrap: 'wrap' }}>
          <div style={{ display: 'flex', gap: 6 }}>
            {participants.map(p => (
              <span key={p.userName} style={{
                ...
                background: `${ROLE_COLORS[p.role]}20`, border: `1px solid ${ROLE_COLORS[p.role]}40`,
                color: ROLE_COLORS[p.role], display: 'flex', alignItems: 'center', gap: 4,
              }}>
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: `${ROLE_COLORS[role]}20`, border: `1px solid ${ROLE_COLORS[role]}40`,
                    color: ROLE_COLORS[role], display: 'flex', alignItems: 'center', gap: 4,
                  }}
                >
                  <Send size={14} />
                </button>
          ...
          <button
            ...
            style={{
              ...
              color: '#ef4444', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: 4,
            }}
          >
