                            ...
                            <div style={stepCardPanel}>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onChange={(e) =>
                                                onStrategyChange(
                                                    e.target
                                                        .value as import('../../kernel/contracts/debate-types').DebateSessionStrategy,
                                                )
                                            }
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            onTemperatureChange(parseInt(e.target.value))
                                        }
                        ...
                        {step === 1 && (
                            <div style={stepCardPanel}>
                                <div style={textCenter}>
                                    ...
                                    <p style={pageSubtitleMuted}>
                                        Choose agents and set their thinking archetype.
                                    </p>
                                </div>
                        ...
                        {step === 2 && (
                            <div style={stepCardPanel}>
                                <div style={textCenter}>
                                    ...
                                    <p style={pageSubtitleMuted}>
                                        Verify configuration, probe participants, and start.
                                    </p>
                                </div>
                ...
                >
                    ...
                    {step < 2 ? (
                        <button
                            ...
                            style={{
                                ...btnNavShape,
                                opacity: !canNextStep() ? 0.4 : 1,
                                cursor: !canNextStep() ? 'default' : 'pointer',
                                background: 'linear-gradient(90deg, #9333ea, #a855f7)',
                            }}
                        >
