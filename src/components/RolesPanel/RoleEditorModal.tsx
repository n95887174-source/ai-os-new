...
import { X, Settings2, SlidersHorizontal, ShieldCheck, CheckCircle2, Wrench } from 'lucide-react';
                    ...
                    <div>
                        ...
                        >
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    onChange({ ...r, baseTemperature: parseFloat(e.target.value) })
                                }
                                style={{
                                    flex: 1,
                                    cursor: 'pointer',
                ...
                <div>
                    ...
                    >
                        {PROMPT_TEMPLATES.map((tpl) => (
                            <button
                                key={tpl.label}
                                onClick={() => onChange({ ...r, systemPrompt: tpl.prompt })}
                                style={{
                    ...
                    <textarea
                        ...
                        onChange={(e) => onChange({ ...r, systemPrompt: e.target.value })}
                                ...
                                >
                                    ...
                                    >
                                        {isEquipped ? (
                                            ...
                                            <Wrench size={16} color="#64748b" aria-hidden="true" />
                                        )}
                                    </div>
                                    {tool.name}
                                </div>
