...
const RolesPanel: React.FC = () => {
    ...
    const PROMPT_TEMPLATES = [
        {
            label: 'Coding Agent',
            prompt: 'You are an expert software engineer. Your task is {{task}}. Write clean, well-documented, and efficient code. Follow best practices and consider edge cases.',
        },
        {
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            whileHover={{
                                                ...
                                                background:
                                                    'linear-gradient(145deg, rgba(59,130,246,0.05) 0%, rgba(0,0,0,0) 100%)',
                                            }}
                                            onKeyDown={(e) => {
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: '0.85rem', color: '#94a3b8' }}>
                                            Define core logic, system prompts, and capability
                                            access.
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                >
                                    <div>
                                        ...
                                        <input
                                            ...
                                            value={r.name}
                                            onChange={(e) =>
                                                setEditingRole({ ...r, name: e.target.value })
                                            }
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        value={r.description || ''}
                                        onChange={(e) =>
                                            setEditingRole({ ...r, description: e.target.value })
                                        }
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        >
                                            {t('roles.system_prompt_identity')}
                                        </span>
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) =>
                                            setEditingRole({ ...r, systemPrompt: e.target.value })
                                        }
                                        onFocus={(e) => (e.target.style.borderColor = '#3b82f6')}
                                        onBlur={(e) =>
