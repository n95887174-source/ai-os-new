...
} from '../../kernel/contracts/counterfactual';
            ...
            >
                ...
                >
                    ...
                    {traces.map((t) => (
                        ...
                        >
                            <button
                                onClick={() => runCounterfactual(t, null)}
                                style={{
                                    ...CARD,
                                    ...
                                    border: 'none',
                                    background:
                                        selectedTrace?.causalId === t.causalId
                                            ? 'rgba(245,158,11,0.1)'
                                        ...
                                        const deltaColor =
                                            d.delta > 0.05
                                                ...
                                                : d.delta < -0.05
                                                  ? '#ef4444'
                                                  : '#64748b';
                                        const isSelectedOriginal =
                                            d.provider === result.original.selected;
                                        const isSelectedSim =
                                            d.provider === result.simulated.selected;
                                        return (
                                            <div
                                                key={d.provider}
                                                style={{
                                ...
                                <div style={CARD}>
                                    ...
                                    {explanation.decisiveComponents.length > 0 && (
                                        <>
                                            ...
                                            >
                                                {String(
                                                    explanation.decisiveComponents[0].component,
                                                )}{' '}
                                                ({explanation.decisiveComponents[0].provider}):{' '}
                                                {explanation.decisiveComponents[0].contribution > 0
                                                    ? '+'
                                                    : ''}
                                                {explanation.decisiveComponents[0].contribution.toFixed(
                                                    3,
                                                )}
                                            </div>
                                        </>
                                    ...
                                    {explanation.decisiveComponents.length > 1 && (
                                        <>
                                            ...
                                            {explanation.decisiveComponents
                                                .slice(1)
                                                .map((dc, _i) => (
                                                    <div
                                                        key={dc.component}
                                                    ...
                                                    >
                                                        {String(dc.component)} ({dc.provider}):{' '}
                                                        {dc.contribution > 0 ? '+' : ''}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ({explanation.originalWinner} →{' '}
                                                {explanation.simulatedWinner})
                                            </span>
                                        </div>
                                    </div>
                                </div>
