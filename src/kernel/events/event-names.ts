...
export const EVENTS = {
  ...
  PROVIDER_CIRCUIT_BREAKER_SYNCED: ProviderEvents.PROVIDER_CIRCUIT_BREAKER_SYNCED,
  PROVIDER_RATE_LIMIT_SYNCED: ProviderEvents.PROVIDER_RATE_LIMIT_SYNCED,
  PROVIDER_ERROR_SYNCED: ProviderEvents.PROVIDER_ERROR_SYNCED,
  PROVIDER_STATE_DESYNC: ProviderEvents.PROVIDER_STATE_DESYNC,
  ...
  CHAT_SUMMARY_CREATED: ChatEvents.SUMMARY_CREATED,
  ...
  KERNEL_HEARTBEAT: SystemEvents.KERNEL_HEARTBEAT,
  KERNEL_STATE_RESET: SystemEvents.KERNEL_STATE_RESET,
  BOOTSTRAP_PHASE: SystemEvents.BOOTSTRAP_PHASE,
  RUNTIME_READY: SystemEvents.RUNTIME_READY,
  RUNTIME_FAILED: SystemEvents.RUNTIME_FAILED,
  SHUTDOWN: SystemEvents.SHUTDOWN,
  CLEAR_DATA: SystemEvents.CLEAR_DATA,
  EVENTBUS_BACKPRESSURE: SystemEvents.EVENTBUS_BACKPRESSURE,
  ...
  DEBATE_BUDGET_EXCEEDED: DebateRuntimeEvents.BUDGET_EXCEEDED,
  DEBATE_BUDGET_PRESSURE_CHANGED: DebateRuntimeEvents.BUDGET_PRESSURE_CHANGED,
  ...
  DEBATE_VERDICT_GENERATED: DomainEvents.DEBATE_VERDICT_GENERATED,
  DEBATE_ENDED: DomainEvents.DEBATE_ENDED,
  DEBATE_SESSION_CONFLICT: DomainEvents.DEBATE_SESSION_CONFLICT,
  DEBATE_FACT_CHECKED: DomainEvents.DEBATE_FACT_CHECKED,
  SESSION_DELETED: DomainEvents.SESSION_DELETED,
  ELO_RATING_UPDATED: DomainEvents.ELO_RATING_UPDATED,
  CACHE_INVALIDATED: DomainEvents.CACHE_INVALIDATED,
  ...
  SNAPSHOT_RESTORED: DomainEvents.SNAPSHOT_RESTORED,
  ...
  AGENT_DELEGATION_CREATED: 'agent:delegation:created',
  ...
  AGENT_TRIGGER_CREATED: 'agent:trigger:created',
  AGENT_TRIGGER_FIRED: 'agent:trigger:fired',
  AGENT_WIZARD_CONFIG_GENERATED: 'agent:wizard:config-generated',
  AQUARIUM_SCREENSHOT_CAPTURED: 'aquarium:screenshot:captured',
  ARCH_REVIEW_DIFF_CREATED: 'arch-review:diff:created',
  ARCH_REVIEW_SNAPSHOT_CREATED: 'arch-review:snapshot:created',
  CHAT_FORKED: 'chat:forked',
  CHAT_RESTORED_FROM_SNAPSHOT: 'chat:restored-from-snapshot',
  CHAT_REWOUND: 'chat:rewound',
  CHAT_TEMPLATE_CREATED: 'chat:template:created',
  CHAT_TEMPLATE_DELETED: 'chat:template:deleted',
  CHAT_TEMPLATE_UPDATED: 'chat:template:updated',
  CHAT_UNDO_REWIND: 'chat:undo-rewind',
  CITATIONS_ADDED: 'citations:added',
  COLLAB_RESEARCH_CONTRIBUTION_ADDED: 'collab-research:contribution:added',
  COLLAB_RESEARCH_FINDING_ADDED: 'collab-research:finding:added',
  COLLAB_RESEARCH_SESSION_COMPLETED: 'collab-research:session:completed',
  COLLAB_RESEARCH_SESSION_CREATED: 'collab-research:session:created',
  COLLAB_RESEARCH_USER_JOINED: 'collab-research:user:joined',
  COLLAB_RESEARCH_USER_LEFT: 'collab-research:user:left',
  EXPERIMENT_CREATED_FROM_HYPOTHESIS: 'experiment:created-from-hypothesis',
  FINDINGS_AGGREGATED: 'findings:aggregated',
  HYPOTHESIS_EXPERIMENT_RESULT: 'hypothesis:experiment:result',
  HYPOTHESIS_VALIDATED: 'hypothesis:validated',
  KEY_ROTATION_NOTIFICATION: 'key:rotation:notification',
  KEY_ROTATION_POLICY_CREATED: 'key:rotation-policy:created',
  KEY_ROTATION_POLICY_DELETED: 'key:rotation-policy:deleted',
  KEY_ROTATION_POLICY_UPDATED: 'key:rotation-policy:updated',
  KEY_ROTATION_TRIGGERED: 'key:rotation:triggered',
  LOCAL_PROVIDER_DETECTED: 'local-provider:detected',
  MEMORY_CHUNK_ADDED: 'memory:chunk:added',
  MEMORY_CHUNK_DELETED: 'memory:chunk:deleted',
  MEMORY_CHUNK_UPDATED: 'memory:chunk:updated',
  MESSAGE_FEEDBACK_SUBMITTED: 'message:feedback:submitted',
  PROMPT_AUDIT_BASELINE_SET: 'prompt-audit:baseline:set',
  PROMPT_AUDIT_COMPARISON_CREATED: 'prompt-audit:comparison:created',
  PROVIDER_CATALOG_ADDED: 'provider:catalog:added',
  PROVIDER_CATALOG_PROBED: 'provider:catalog:probed',
  PROVIDER_PERSONALITY_CALIBRATED: 'provider:personality:calibrated',
  PROVIDER_PERSONALITY_UPDATED: 'provider:personality:updated',
  PROXY_DOWN: 'proxy:down',
  PROXY_UP: 'proxy:up',
  RESEARCH_FINDINGS_AVAILABLE: 'research:findings:available',
  RESEARCH_FINDING_RESOLVED: 'research:finding:resolved',
  RESEARCH_FINDING_SYNCED: 'research:finding:synced',
  RESEARCH_GOAL_CREATED: 'research:goal:created',
  RESEARCH_GOAL_PAUSED: 'research:goal:paused',
  RESEARCH_GOAL_PROGRESS_UPDATED: 'research:goal:progress-updated',
  RESEARCH_GOAL_RESUMED: 'research:goal:resumed',
  RESEARCH_KEY_RESULT_UPDATED: 'research:key-result:updated',
  RESEARCH_RECOMMENDATION_APPLIED: 'research:recommendation:applied',
  RESEARCH_RECOMMENDATION_CREATED: 'research:recommendation:created',
  RESEARCH_RECOMMENDATION_DISMISSED: 'research:recommendation:dismissed',
  RESEARCH_SCHEDULE_CREATED: 'research:schedule:created',
  RESEARCH_SCHEDULE_DELETED: 'research:schedule:deleted',
  RESEARCH_SCHEDULE_UPDATED: 'research:schedule:updated',
  RESEARCH_TRIGGERED: 'research:triggered',
  ROLE_CREATED: 'role:created',
  ROLE_DELETED: 'role:deleted',
  ROLE_LIBRARY_INSTALLED: 'role:library:installed',
  ROLE_LIBRARY_UNINSTALLED: 'role:library:uninstalled',
  ROLE_MODEL_PREFERENCES_UPDATED: 'role:model-preferences:updated',
  ...
  VERSUS_USER_COMPLETED: 'versus-user:completed',
  VERSUS_USER_ROUND_COMPLETE: 'versus-user:round-complete',
