...
export type VotingMechanism = 'simple_majority' | 'supermajority' | 'unanimous' | 'ranked_choice' | 'weighted';
...
export type ReviewCriteria = 'correctness' | 'completeness' | 'clarity' | 'evidence' | 'originality' | 'feasibility';
