...
export interface CognitiveZone {
  ...
  readonly type: 'contradiction_cluster' | 'low_confidence_region' | 'reasoning_collapse' | 'hallucination_risk';
...
export interface CognitiveIssue {
  readonly type: 'reasoning_collapse' | 'contradiction_spike' | 'confidence_drop' | 'agent_failure' | 'budget_pressure';
