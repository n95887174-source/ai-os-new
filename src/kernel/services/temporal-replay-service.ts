...
function keyStateToProviderMetrics(keyStateData: Record<string, unknown>): Record<string, ProviderMetrics> {
...
function providerMetricsToStateBlock(metrics: Record<string, ProviderMetrics>): Record<string, ProviderBlock> {
