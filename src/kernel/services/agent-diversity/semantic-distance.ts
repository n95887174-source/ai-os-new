import type { Claim } from '../debate-governor/types';
...
export function computeAgentPairSimilarity(
  claimsA: Claim[],
  claimsB: Claim[],
): number {
...
export function computeSemanticDiversityScore(
  similaritiesToOthers: number[],
): number {
