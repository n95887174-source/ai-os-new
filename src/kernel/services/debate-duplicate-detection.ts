...
const SYNONYM_GROUPS: string[][] = [
  ['argue', 'argues', 'argued', 'arguing', 'argument', 'claim', 'claims', 'assert', 'asserts', 'assertion', 'contend', 'contends', 'contention'],
  ['agree', 'agrees', 'agreed', 'agreeing', 'concur', 'concurs', 'concurred', 'concurring', 'support', 'supports', 'supported'],
  ['disagree', 'disagrees', 'disagreed', 'disagreeing', 'oppose', 'opposes', 'opposed', 'opposing', 'reject', 'rejects', 'rejected', 'refute', 'refutes', 'refuted'],
  ...
  ['show', 'shows', 'shown', 'demonstrate', 'demonstrates', 'demonstrated', 'indicate', 'indicates', 'indicated', 'suggest', 'suggests', 'suggested'],
  ['cause', 'causes', 'caused', 'leading', 'leads', 'lead', 'result', 'results', 'resulted', 'contribute', 'contributes', 'contributed'],
...
export function isDuplicateArgument(
  ...
  for (const existing of existingArgs) {
    ...
    // Bigram overlap
    const bigramSim = bigrams.size > 0 && existingBigrams.size > 0
