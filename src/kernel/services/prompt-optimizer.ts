...
const SUGGESTIONS: OptimizationSuggestion[] = [
  ...
  },
  {
    ...
    apply: (p) => {
      const removals = [
        /in order to/gi, /please /gi, /kindly /gi, /feel free to/gi,
        /I would like you to/gi, /I need you to/gi, /Your task is to/gi,
        /You are to /gi, /The goal is to /gi,
      ];
      let r = p;
...
export class PromptOptimizer {
  analyze(prompt: string, stats: { calls?: number; errors?: number; latency?: number; tokens?: number }): OptimizationSuggestion[] {
