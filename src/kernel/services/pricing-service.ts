...
const FALLBACK_PRICING: Record<string, { input: number; output: number; provider?: string }> = {
    ...
    'gemini-2.0-flash': { input: 0.08, output: 0.3, provider: 'google' },
    'gemini-3.1-flash': { input: 0.5, output: 2.0, provider: 'google' },
    'gemini-3-flash': { input: 0.4, output: 1.5, provider: 'google' },
    'gemini-2.5-pro': { input: 2.5, output: 10.0, provider: 'google' },
