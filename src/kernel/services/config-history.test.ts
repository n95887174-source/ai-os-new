...
describe('ConfigHistoryService', () => {
  ...
  it('should seed initial version and register new commits', () => {
    ...
    const commit1 = service.commit(nextConfig, 'Alice', 'Change max retries to 5');
  ...
  it('should generate accurate added, deleted, and updated diff items', () => {
    const service = new ConfigHistoryService();
    ...
    const nextVer = service.commit(modifiedConfig, 'Charlie', 'Modify config for diffing');
