...
export const rawConfig: ConfigRegistry = {
  ...
  router: {
    ...
    providerByComplexity: {
      multimodal: { provider: 'gemini', model: 'gemini-1.5-flash' },
      long: { provider: 'gemini', model: 'gemini-1.5-flash' },
      complexCode: { provider: 'gemini', model: 'gemini-1.5-flash' },
  ...
  llm: {
    ...
    pricing: {
      ...
      'gemini-1.5-flash': { inputPer1K: 0.0001, outputPer1K: 0.0004 },
    },
