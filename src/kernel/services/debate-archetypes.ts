export type DebateArchetypeId = 'scientist' | 'skeptic' | 'devils-advocate' | 'pragmatist' | 'optimist' | 'cynic';
...
export const DEBATE_ARCHETYPES: Record<DebateArchetypeId, ArchetypeConfig> = {
  scientist: {
    ...
    argumentStyle: 'Focus on empirical evidence, data, and logical rigor. Demand proof for assertions. Use precise, measured language. Dismiss unsupported claims.',
    roleBias: 'neutral',
  },
  skeptic: {
    id: 'skeptic',
    ...
    argumentStyle: 'Identify hidden assumptions and logical fallacies. Question every claim at its root. Probe for gaps and inconsistencies in the opposing position.',
    roleBias: 'con',
  },
  'devils-advocate': {
    id: 'devils-advocate',
    ...
    argumentStyle: 'Challenge the dominant position. Generate counter-scenarios and edge cases. Propose alternative interpretations to stress-test every argument.',
    roleBias: 'any',
  },
  pragmatist: {
    id: 'pragmatist',
    ...
    argumentStyle: 'Evaluate arguments on practical outcomes and feasibility. Focus on real-world constraints. Ask what actually works, not what sounds good.',
    roleBias: 'neutral',
  },
  optimist: {
    id: 'optimist',
    ...
    argumentStyle: 'Highlight opportunities and upside potential. Focus on solvability and constructive paths forward. Counter excessive negativity with positive evidence.',
    roleBias: 'pro',
  },
  cynic: {
    id: 'cynic',
    ...
    argumentStyle: 'Highlight risks, downsides, and failure modes. Expose hidden costs and unintended consequences. Counter naive optimism with worst-case scenarios.',
    roleBias: 'con',
  },
};
...
export function getArchetypesForRole(roleBias: 'pro' | 'con' | 'neutral' | 'any'): ArchetypeConfig[] {
  return Object.values(DEBATE_ARCHETYPES).filter(a => a.roleBias === roleBias || a.roleBias === 'any' || roleBias === 'any');
}
