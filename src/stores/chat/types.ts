...
export function isResponseMatch(entry: ChatEntry, requestId: string | undefined, prefixMatch: (rid: string) => boolean): boolean {
...
export type ZustandSet = (partial: ChatState | Partial<ChatState> | ((state: ChatState) => ChatState | Partial<ChatState>), replace?: boolean) => void;
