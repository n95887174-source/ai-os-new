import type { DebateSessionStrategy, DebateParticipant, DebateConfig, DebateSession } from '../../kernel/contracts/debate-types';
...
export interface DebateSessionStoreActions {
  init: () => void;
  createSession: (topic: string, strategy: DebateSessionStrategy, participants: DebateParticipant[], config: DebateConfig) => Promise<string>;
  loadSession: (id: string) => Promise<DebateSession | null>;
  saveCurrentSession: () => Promise<void>;
  listSessions: (filters?: { status?: string; folder?: string; search?: string; tags?: string[] }) => Promise<DebateSessionMeta[]>;
