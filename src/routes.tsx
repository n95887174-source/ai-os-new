...
import {
  ...
  MessageSquare as MessageSquareIcon, FolderTree, LayoutDashboard as SessionHubIcon, Bookmark, CheckSquare, FolderOpen,
  ...
  BookText, Search as SearchIcon, FlaskConical, Shield, ClipboardList,
  Wrench, HardDrive, Webhook, RefreshCw, Home, Search, MessageSquare,
} from 'lucide-react';
...
export const NAV_SECTIONS: NavSection[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { id: 'cost-analytics', labelKey: 'nav.cost_analytics',  icon: <BarChart3 size={18} />,       color: '#10b981', lazy: true, level: 'L2' },
      { id: 'routing',        labelKey: 'nav.routing_ai',      icon: <RoutingIcon size={18} />,     color: '#8b5cf6', lazy: true, level: 'L2' },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      { id: 'chat',           labelKey: 'nav.chat',            icon: <MessageSquareIcon size={18} />,   color: '#10b981', lazy: true, level: 'L0' },
      ...
      { id: 'tasks',          labelKey: 'nav.tasks',           icon: <CheckSquare size={18} />,     color: '#f59e0b', level: 'L1' },
      { id: 'files',          labelKey: 'nav.files',           icon: <FolderOpen size={18} />,      color: '#a855f7', lazy: true, level: 'L1' },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      { id: 'debate',           labelKey: 'nav.debate_arena',      icon: <MessageCircle size={18} />, color: '#a855f7', lazy: true, level: 'L1' },
      { id: 'builder',          labelKey: 'nav.builder',           icon: <Box size={18} />,           color: '#f59e0b', lazy: true, level: 'L2' },
      { id: 'debate-live',      labelKey: 'nav.debate_live',       icon: <Radio size={18} />,         color: '#ef4444', lazy: true, level: 'L1' },
      { id: 'debate-workspace', labelKey: 'nav.debate_rooms',      icon: <GitBranch size={18} />,     color: '#8b5cf6', lazy: true, level: 'L2' },
      { id: 'debate-replay',    labelKey: 'nav.debate_replay',     icon: <History size={18} />,       color: '#6b7280', lazy: true, level: 'L2' },
      { id: 'debate-tournament', labelKey: 'nav.tournament',       icon: <TournamentZap size={18} />, color: '#f97316', lazy: true, level: 'L1' },
      { id: 'argument-graph',   labelKey: 'nav.argument_graph',    icon: <GitBranch size={18} />,     color: '#8b5cf6', lazy: true, level: 'L2' },
      { id: 'strategy-builder',  labelKey: 'nav.strategy_builder', icon: <GitMerge size={18} />,      color: '#06b6d4', lazy: true, level: 'L2' },
      { id: 'debate-analysis',  labelKey: 'nav.debate_analysis',   icon: <Brain size={18} />,         color: '#a855f7', lazy: true, level: 'L1' },
      { id: 'debate-history',   labelKey: 'nav.debate_history',    icon: <History size={18} />,       color: '#6b7280', lazy: true, level: 'L1' },
      { id: 'debates-manager',  labelKey: 'nav.debates_manager',   icon: <FolderTree size={18} />,    color: '#8b5cf6', lazy: true, level: 'L2' },
      { id: 'topics',           labelKey: 'nav.topics',            icon: <Sparkles size={18} />,      color: '#a855f7', lazy: true, level: 'L1' },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      { id: 'agents',            labelKey: 'nav.agents',             icon: <Bot size={18} />,          color: '#8b5cf6', level: 'L1' },
      { id: 'roles',             labelKey: 'nav.roles',              icon: <Users size={18} />,        color: '#3b82f6', level: 'L1' },
      { id: 'sre',               labelKey: 'nav.sre_agent',          icon: <Zap size={18} />,          color: '#ef4444', lazy: true, level: 'L2' },
      { id: 'agent-journal',     labelKey: 'nav.agent_journal',      icon: <BookOpen size={18} />,     color: '#8b5cf6', lazy: true, level: 'L2' },
      { id: 'mission',           labelKey: 'nav.mission_control',    icon: <Zap size={18} />,          color: '#f59e0b', lazy: true, level: 'L2' },
      { id: 'live',              labelKey: 'nav.live_workspace',     icon: <Radio size={18} />,        color: '#3b82f6', lazy: true, level: 'L2' },
      { id: 'agent-marketplace', labelKey: 'nav.agent_marketplace',  icon: <Star size={18} />,         color: '#a855f7', lazy: true, level: 'L2' },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      { id: 'logs',               labelKey: 'nav.log_browser',        icon: <Terminal size={18} />,     color: '#94a3b8', lazy: true, level: 'L1' },
      { id: 'debugger',           labelKey: 'nav.traces',             icon: <GitBranch size={18} />,    color: '#a855f7', lazy: true, level: 'L2' },
      { id: 'router-trace',       labelKey: 'nav.router_trace',       icon: <Network size={18} />,      color: '#8b5cf6', lazy: true, level: 'L2' },
      { id: 'memory',             labelKey: 'nav.memory',             icon: <Database size={18} />,     color: '#a855f7', lazy: true, level: 'L1' },
      { id: 'health',             labelKey: 'nav.health',             icon: <Heart size={18} />,        color: '#ef4444', lazy: true, level: 'L1' },
      { id: 'system-health',      labelKey: 'nav.system_health',      icon: <HealthPulse size={18} />,  color: '#22c55e', lazy: true, level: 'L1' },
      { id: 'docs-health',        labelKey: 'nav.docs_health',        icon: <FileCode size={18} />,     color: '#22c55e', lazy: true, level: 'L2' },
      { id: 'pressure',           labelKey: 'nav.pressure_map',       icon: <Thermometer size={18} />,  color: '#f97316', lazy: true, level: 'L2' },
      { id: 'runtime-pressure',   labelKey: 'nav.runtime_pressure_map', icon: <Activity size={18} />,  color: '#f97316', lazy: true, level: 'L2' },
      { id: 'what-if',            labelKey: 'nav.what_if',            icon: <Shuffle size={18} />,      color: '#8b5cf6', lazy: true, level: 'L2' },
      { id: 'dependency-map',     labelKey: 'nav.dependency_graph',    icon: <GitCompare size={18} />,   color: '#3b82f6', lazy: true, level: 'L2' },
      { id: 'diagnostics',        labelKey: 'nav.diagnostics',        icon: <Crosshair size={18} />,    color: '#10b981', lazy: true, level: 'L2' },
      { id: 'state-inspector',    labelKey: 'nav.state_inspector',     icon: <Eye size={18} />,          color: '#3b82f6', lazy: true, level: 'L2' },
      { id: 'performance-profiler', labelKey: 'nav.performance_profiler', icon: <TrendingUp size={18} />, color: '#a855f7', lazy: true, level: 'L2' },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      { id: 'patterns',           labelKey: 'nav.patterns',              icon: <BookOpen size={18} />,    color: '#10b981', level: 'L1' },
      { id: 'knowledge',          labelKey: 'nav.knowledge',             icon: <Brain size={18} />,       color: '#a855f7', level: 'L0' },
      { id: 'docs',               labelKey: 'nav.docs',                  icon: <BookText size={18} />,    color: '#8b5cf6', level: 'L0' },
      { id: 'decision-log',       labelKey: 'nav.decision_log',          icon: <ClipboardList size={18} />, color: '#10b981', lazy: true, level: 'L2' },
      { id: 'project-os',         labelKey: 'nav.project_os_explorer',   icon: <SearchIcon size={18} />,  color: '#8b5cf6', lazy: true, level: 'L2' },
      { id: 'hypothesis-gen',     labelKey: 'nav.hypothesis_generator',  icon: <FlaskConical size={18} />, color: '#3b82f6', lazy: true, level: 'L2' },
      { id: 'arch-review',        labelKey: 'nav.architecture_review',   icon: <BookText size={18} />,    color: '#10b981', lazy: true, level: 'L2' },
      { id: 'prompt-audit',       labelKey: 'nav.prompt_strategy_audit', icon: <Terminal size={18} />,    color: '#f59e0b', lazy: true, level: 'L2' },
      { id: 'routing-experiments', labelKey: 'nav.model_routing_experiments', icon: <BarChart3 size={18} />, color: '#8b5cf6', lazy: true, level: 'L2' },
      { id: 'gov-stress-test',    labelKey: 'nav.governance_stress_test', icon: <Shield size={18} />,     color: '#ef4444', lazy: true, level: 'L2' },
      { id: 'obs-gaps',           labelKey: 'nav.observability_gaps_scanner', icon: <Crosshair size={18} />, color: '#f97316', lazy: true, level: 'L2' },
      { id: 'debate-system-research', labelKey: 'nav.debate_system_research', icon: <FlaskConical size={18} />, color: '#a855f7', lazy: true, level: 'L2' },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      { id: 'skills',      labelKey: 'nav.skills',       icon: <GitMerge size={18} />,   color: '#f59e0b', level: 'L1' },
      { id: 'tools',       labelKey: 'nav.tools',        icon: <Wrench size={18} />,     color: '#f59e0b', level: 'L1' },
      { id: 'cache',       labelKey: 'nav.cache',        icon: <HardDrive size={18} />,  color: '#10b981', lazy: true, level: 'L2' },
      { id: 'webhooks',    labelKey: 'nav.webhooks',     icon: <Webhook size={18} />,    color: '#a855f7', lazy: true, level: 'L2' },
      { id: 'rotations',   labelKey: 'nav.rotations',    icon: <RefreshCw size={18} />,  color: '#3b82f6', lazy: true, level: 'L2' },
      { id: 'service-registry', labelKey: 'nav.service_registry', icon: <Box size={18} />, color: '#8b5cf6', lazy: true, level: 'L2' },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    items: [
      { id: 'settings',      labelKey: 'nav.settings',     icon: <Settings size={18} />,       color: '#64748b', level: 'L0' },
      { id: 'policies',      labelKey: 'nav.policies',     icon: <Shield size={18} />,         color: '#10b981', level: 'L1' },
      { id: 'policy-editor', labelKey: 'nav.policy_editor', icon: <Zap size={18} />,            color: '#06b6d4', lazy: true, level: 'L2' },
      { id: 'audit',         labelKey: 'nav.audit_log',    icon: <SearchIcon size={18} />,     color: '#94a3b8', level: 'L1' },
      { id: 'history',       labelKey: 'nav.config_history', icon: <History size={18} />,      color: '#f59e0b', level: 'L1' },
    ],
  },
] as const;
